...
.method public static constructor <clinit>()V
    ...
    .line 1
    invoke-static {v1}, Landroidx/savedstate/d;->v([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    sput-object v1, Lld/e0;->j:Ljava/util/List;
    ...
    sput-object v0, Lld/e0;->k:Ljava/util/List;
...
.method public constructor <init>(Lcom/supercell/id/ui/MainActivity;Ljava/lang/String;Landroid/view/View;)V
    ...
    iput-object p1, p0, Lld/e0;->h:Lcom/supercell/id/ui/MainActivity;

    iput-object p2, p0, Lld/e0;->i:Ljava/lang/String;
    ...
    iput-object p2, p0, Lld/e0;->a:Lse/o;
    ...
    iput-object p2, p0, Lld/e0;->b:Lse/o;
    ...
    iput-object v1, p0, Lld/e0;->c:Lse/o;
    ...
    iput-object v2, p0, Lld/e0;->d:Lse/o;

    const/4 v3, 0x3

    new-array v3, v3, [Lse/h0;
    ...
    new-instance v7, Lwd/c1;

    invoke-direct {v7, v3, v0}, Lwd/c1;-><init>([Lse/h0;Lde/d;)V
    ...
    iput-object p1, p0, Lld/e0;->e:Lse/h0;

    .line 7
    invoke-static {p3}, Lwd/f2;->b(Landroid/view/View;)Landroid/graphics/Rect;

    move-result-object p1

    iput-object p1, p0, Lld/e0;->f:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Lld/e0;->g:Ljava/lang/ref/WeakReference;
...
.method public a()Lse/h0;
    ...
    .line 1
    iget-object v0, p0, Lld/e0;->a:Lse/o;
...
.method public b()V
    ...
    .line 1
    iget-object v0, p0, Lld/e0;->c:Lse/o;
...
.method public c(Ljava/util/List;)V
    ...
    .line 2
    iget-object v0, v7, Lld/e0;->h:Lcom/supercell/id/ui/MainActivity;
    ...
    sget-object v0, Lld/e0;->k:Ljava/util/List;

    goto :goto_0

    :cond_0
    sget-object v0, Lld/e0;->j:Ljava/util/List;
    ...
    .line 6
    iget-object v0, v0, Lqd/j;->h:Lqd/n0;

    invoke-virtual {v0, v4}, Lqd/m0;->c(Ljava/lang/String;)Ljava/io/File;
    ...
    .line 11
    iget-object v9, v5, Lwd/r;->m:La2/a;
    ...
    invoke-static/range {v9 .. v15}, La2/a;->b(La2/a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;ZI)V
    ...
    .line 16
    iget-object v9, v0, Lwd/r;->m:La2/a;
    ...
    .line 18
    iget-object v0, v7, Lld/e0;->a:Lse/o;
    ...
    .line 21
    iget-object v0, v7, Lld/e0;->d:Lse/o;
    ...
    iget-object v1, v7, Lld/e0;->h:Lcom/supercell/id/ui/MainActivity;

    iget-object v3, v7, Lld/e0;->i:Ljava/lang/String;

    invoke-direct {v0, v1, v8, v3}, Lld/a0;-><init>(Landroid/content/Context;Landroid/media/MediaPlayer;Ljava/lang/String;)V

    .line 25
    iget-object v1, v7, Lld/e0;->f:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Lld/a0;->setIdLogoFrameOnScreen(Landroid/graphics/Rect;)V
    ...
    .line 33
    iget-object v2, v1, Lcom/supercell/id/ui/game/GameFragment;->w0:Lse/o;

    if-eqz v2, :cond_a

    .line 34
    sget-object v3, Lld/e0$a;->a:Lld/e0$a;

    invoke-static {v2, v0, v3}, Lwd/e1;->n(Lse/h0;Ljava/lang/Object;Lke/p;)Lse/h0;
    ...
    .line 36
    new-instance v1, Lld/e0$b;

    invoke-direct {v1, v7, v0, v8}, Lld/e0$b;-><init>(Lld/e0;Lld/a0;Landroid/media/MediaPlayer;)V
    ...
    invoke-direct/range {v1 .. v6}, Lld/e0$c;-><init>(Lld/e0;Landroid/media/MediaPlayer;Ljava/lang/String;Ljava/lang/ref/WeakReference;Lld/a0;)V

    invoke-virtual {v8, v10}, Landroid/media/MediaPlayer;->setOnErrorListener(Landroid/media/MediaPlayer$OnErrorListener;)V

    .line 38
    invoke-virtual {v0}, Lld/a0;->getVideoReady()Lse/o;

    move-result-object v1

    new-instance v2, Lld/e0$d;

    invoke-direct {v2, v7}, Lld/e0$d;-><init>(Lld/e0;)V
    ...
    sget-object v4, Lld/e0$e;->a:Lld/e0$e;

    .line 40
    new-instance v5, Lld/e0$f;

    invoke-direct {v5, v9, v0}, Lld/e0$f;-><init>(Ljava/lang/ref/WeakReference;Lld/a0;)V
    ...
    .line 42
    iget-object v1, v7, Lld/e0;->e:Lse/h0;

    .line 43
    new-instance v2, Lld/e0$g;

    invoke-direct {v2, v8, v9, v0}, Lld/e0$g;-><init>(Landroid/media/MediaPlayer;Ljava/lang/ref/WeakReference;Lld/a0;)V
    ...
    .line 45
    new-instance v2, Lld/e0$h;

    invoke-direct {v2, v7}, Lld/e0$h;-><init>(Lld/e0;)V

    invoke-static {v1, v2}, Lwd/e1;->b(Lse/h0;Lke/a;)Lse/h0;
    ...
    .line 49
    sget-object v1, Lqc/a$a;->NEW_GAME:Lqc/a$a;
...
.method public cancel()V
    ...
    .line 4
    iget-object v0, p0, Lld/e0;->b:Lse/o;
    ...
    .line 8
    iget-object v0, p0, Lld/e0;->d:Lse/o;
...
.method public e()Z
    ...
    .line 1
    iget-object v0, p0, Lld/e0;->e:Lse/h0;
