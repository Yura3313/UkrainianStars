...
.method public a(Landroidx/recyclerview/widget/RecyclerView$z;Ln8/w;)V
    ...
    .line 2
    iget-object v3, v0, Lpa/u;->a:Landroid/content/Context;

    const v4, 0x1010036

    invoke-static {v3, v4}, Lgb/f;->a(Landroid/content/Context;I)I

    move-result v3

    .line 3
    iget-object v4, v0, Lpa/u;->a:Landroid/content/Context;

    const v5, 0x1010038

    invoke-static {v4, v5}, Lgb/f;->a(Landroid/content/Context;I)I

    move-result v4

    .line 4
    invoke-virtual {v2}, Ln8/l;->q()Ljava/lang/String;

    move-result-object v5

    .line 5
    invoke-virtual {v2}, Ln8/w;->i()Ljava/lang/String;

    move-result-object v6

    .line 6
    iget v7, v2, Ln8/k0;->I:I
    ...
    invoke-static {v3, v7}, Lgb/f;->a(Landroid/content/Context;I)I

    move-result v3

    .line 8
    iget-object v7, v0, Lpa/u;->a:Landroid/content/Context;
    ...
    .line 9
    invoke-virtual {v2}, Ln8/w;->c()Ljava/lang/String;
    ...
    .line 10
    iget-object v9, v0, Lpa/u;->a:Landroid/content/Context;

    sget v14, Lcom/helpshift/R$string;->hs__attachment_downloaded__voice_over:I

    new-array v15, v11, [Ljava/lang/Object;

    iget-object v8, v2, Ln8/l;->B:Ljava/lang/String;
    ...
    .line 12
    iget-object v6, v0, Lpa/u;->a:Landroid/content/Context;
    ...
    invoke-static {v4, v7}, Lgb/f;->a(Landroid/content/Context;I)I
    ...
    .line 19
    iget-object v8, v0, Lpa/u;->a:Landroid/content/Context;

    sget v15, Lcom/helpshift/R$string;->hs__attachment_name_voice_over:I

    new-array v14, v14, [Ljava/lang/Object;

    iget-object v9, v2, Ln8/l;->B:Ljava/lang/String;
    ...
    iget-object v15, v2, Ln8/l;->B:Ljava/lang/String;
    ...
    .line 29
    :cond_5
    invoke-virtual {v2}, Ln8/k0;->t()Ljava/lang/String;
    ...
    iget-object v10, v2, Ln8/l;->B:Ljava/lang/String;
    ...
    iget-object v14, v2, Ln8/l;->B:Ljava/lang/String;
    ...
    .line 41
    :goto_4
    iget-object v14, v2, Ln8/w;->i:Ln8/i0;

    move-object/from16 v17, v13

    .line 42
    iget-object v13, v1, Lpa/j0$a;->E:Landroid/view/View;

    invoke-virtual {v0, v13, v11}, Lpa/u;->k(Landroid/view/View;Z)V

    .line 43
    iget-object v11, v1, Lpa/j0$a;->F:Landroid/widget/ImageView;

    invoke-virtual {v0, v11, v12}, Lpa/u;->k(Landroid/view/View;Z)V

    .line 44
    iget-object v11, v1, Lpa/j0$a;->D:Landroid/widget/ProgressBar;

    invoke-virtual {v0, v11, v7}, Lpa/u;->k(Landroid/view/View;Z)V

    .line 45
    iget-object v7, v1, Lpa/j0$a;->H:Landroid/widget/ImageView;

    invoke-virtual {v0, v7, v9}, Lpa/u;->k(Landroid/view/View;Z)V

    .line 46
    iget-object v7, v1, Lpa/j0$a;->G:Landroid/widget/TextView;

    .line 47
    iget-boolean v11, v14, Ln8/i0;->g:Z

    .line 48
    invoke-virtual {v0, v7, v11}, Lpa/u;->k(Landroid/view/View;Z)V

    .line 49
    iget-object v7, v1, Lpa/j0$a;->z:Landroid/view/View;

    invoke-virtual {v7, v8}, Landroid/view/View;->setAlpha(F)V

    .line 50
    iget-object v7, v1, Lpa/j0$a;->B:Landroid/widget/TextView;
    ...
    .line 51
    iget-object v7, v1, Lpa/j0$a;->C:Landroid/widget/TextView;

    invoke-virtual {v7, v5}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 52
    iget-object v5, v1, Lpa/j0$a;->B:Landroid/widget/TextView;

    invoke-virtual {v5, v3}, Landroid/widget/TextView;->setTextColor(I)V

    .line 53
    iget-boolean v3, v14, Ln8/i0;->g:Z

    if-eqz v3, :cond_7

    .line 54
    iget-object v3, v1, Lpa/j0$a;->G:Landroid/widget/TextView;
    ...
    .line 56
    iget-object v3, v1, Lpa/j0$a;->H:Landroid/widget/ImageView;
    ...
    .line 58
    iget-object v3, v1, Lpa/j0$a;->z:Landroid/view/View;

    new-instance v4, Lpa/i0;

    invoke-direct {v4, v0, v2}, Lpa/i0;-><init>(Lpa/j0;Ln8/k0;)V
    ...
    .line 59
    :cond_9
    iget-object v2, v1, Lpa/j0$a;->z:Landroid/view/View;

    invoke-virtual {v2, v4}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 60
    :goto_6
    iget-object v2, v1, Lpa/j0$a;->A:Landroid/view/View;
    ...
    .line 62
    iget-object v1, v1, Lpa/j0$a;->H:Landroid/widget/ImageView;
...
.method public b(Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    invoke-direct {v0, p0, p1}, Lpa/j0$a;-><init>(Lpa/j0;Landroid/view/View;)V
