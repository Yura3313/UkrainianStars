...
.method public a(Landroidx/recyclerview/widget/RecyclerView$z;Ln8/w;)V
    ...
    .line 3
    iget-object v1, p1, Lpa/k0$a;->z:Landroid/widget/TextView;
    ...
    .line 17
    :goto_2
    iget-object v7, p1, Lpa/k0$a;->D:Landroid/view/View;

    invoke-virtual {v7, v5}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    .line 18
    iget-object v5, p1, Lpa/k0$a;->A:Landroid/widget/TextView;

    invoke-virtual {v5, v1}, Landroid/widget/TextView;->setTextColor(I)V

    .line 19
    iget-object v1, p1, Lpa/k0$a;->C:Landroid/widget/FrameLayout;
    ...
    .line 20
    iget-object v2, p1, Lpa/k0$a;->z:Landroid/widget/TextView;
    ...
    .line 22
    iget-object v0, p1, Lpa/k0$a;->B:Landroid/widget/ImageView;
    ...
    .line 24
    iget-object v0, p1, Lpa/k0$a;->C:Landroid/widget/FrameLayout;

    invoke-virtual {p0, v0, p2}, Lpa/u;->i(Landroid/view/View;Ln8/i0;)V

    .line 25
    iget-object v0, p1, Lpa/k0$a;->A:Landroid/widget/TextView;
    ...
    .line 28
    invoke-virtual {p0, v0, p2}, Lpa/u;->k(Landroid/view/View;Z)V

    if-eqz v3, :cond_5

    .line 29
    iget-object p2, p1, Lpa/k0$a;->B:Landroid/widget/ImageView;
    ...
    .line 30
    :cond_5
    iget-object p1, p1, Lpa/k0$a;->B:Landroid/widget/ImageView;
...
.method public b(Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    .line 2
    new-instance v0, Lpa/k0$a;

    invoke-direct {v0, p0, p1}, Lpa/k0$a;-><init>(Lpa/k0;Landroid/view/View;)V

    .line 3
    iget-object p1, v0, Lpa/k0$a;->C:Landroid/widget/FrameLayout;
    ...
    .line 4
    iget-object p1, v0, Lpa/k0$a;->z:Landroid/widget/TextView;
