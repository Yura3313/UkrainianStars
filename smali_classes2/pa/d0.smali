...
.method public a(Landroidx/recyclerview/widget/RecyclerView$z;Ln8/w;)V
    ...
    .line 4
    invoke-static {v3}, Lp5/h;->i(Ljava/lang/CharSequence;)Z
    ...
    .line 8
    iget-object v12, v0, Lpa/u;->a:Landroid/content/Context;
    ...
    invoke-static {v4, v6}, Lgb/f;->a(Landroid/content/Context;I)I
    ...
    invoke-static {v4, v12}, Lgb/f;->a(Landroid/content/Context;I)I
    ...
    .line 21
    :goto_3
    iget-object v10, v2, Ln8/w;->i:Ln8/i0;
    ...
    iget-object v11, v1, Lpa/d0$a;->A:Lcom/helpshift/support/views/HSRoundedImageView;
    ...
    .line 24
    invoke-virtual {v9, v3, v11, v2, v12}, Lza/d;->d(Ljava/lang/String;Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;Lza/e;)V

    .line 25
    iget-object v2, v1, Lpa/d0$a;->A:Lcom/helpshift/support/views/HSRoundedImageView;
    ...
    invoke-virtual {v0, v2, v5}, Lpa/u;->k(Landroid/view/View;Z)V

    .line 27
    iget-object v2, v1, Lpa/d0$a;->B:Landroid/widget/TextView;
    ...
    .line 28
    iget-boolean v2, v10, Ln8/i0;->g:Z
    ...
    .line 32
    iget-boolean v3, v10, Ln8/i0;->g:Z

    .line 33
    invoke-virtual {v0, v2, v3}, Lpa/u;->k(Landroid/view/View;Z)V

    .line 34
    iget-object v2, v1, Lpa/d0$a;->D:Landroid/widget/ProgressBar;

    .line 35
    invoke-virtual {v0, v2, v6}, Lpa/u;->k(Landroid/view/View;Z)V

    .line 36
    iget-object v2, v1, Lpa/d0$a;->C:Landroid/widget/ImageView;

    invoke-virtual {v0, v2, v7}, Lpa/u;->k(Landroid/view/View;Z)V
    ...
    invoke-direct {v3, v0, v4}, Lpa/c0;-><init>(Lpa/d0;Ln8/b0;)V
    ...
    .line 41
    :goto_5
    iget-object v2, v1, Lpa/d0$a;->z:Landroid/view/View;
    ...
    .line 42
    iget-object v1, v1, Lpa/d0$a;->A:Lcom/helpshift/support/views/HSRoundedImageView;
...
.method public b(Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    .line 3
    new-instance v0, Lpa/d0$a;

    invoke-direct {v0, p0, p1}, Lpa/d0$a;-><init>(Lpa/d0;Landroid/view/View;)V
