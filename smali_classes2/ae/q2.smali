...
.method public static final varargs b(Landroid/view/View;Ljava/lang/String;[Lie/d;)V
    ...
    .line 2
    new-instance v0, Lae/q2$a;

    invoke-direct {v0, p1}, Lae/q2$a;-><init>(Ljava/lang/String;)V

    invoke-virtual {p0, v0}, Lcom/supercell/id/view/SubPageTabLayout;->setGetTitleKey(Lre/l;)V

    .line 3
    new-instance p1, Lae/q2$b;

    invoke-direct {p1, p2}, Lae/q2$b;-><init>([Lie/d;)V
...
.method public static final c(Landroid/content/Context;Ljava/util/List;Lre/a;Landroidx/viewpager/widget/ViewPager;Lre/p;)V
    ...
    .line 1
    new-instance v0, Lae/q2$d;

    invoke-direct {v0, p0, p1, p2}, Lae/q2$d;-><init>(Landroid/content/Context;Ljava/util/List;Lre/a;)V
    ...
    .line 3
    new-instance v0, Lae/q2$c;

    invoke-direct {v0, p2, p0, p4}, Lae/q2$c;-><init>(Landroid/view/View;ILre/p;)V
...
.method public static d(Landroid/widget/ImageView;Landroid/widget/ImageView;)V
    ...
    .line 2
    invoke-static {p0, v0}, Lae/q2;->a(Landroid/widget/ImageView;I)Landroid/animation/Animator;
...
.method public static final e(Landroid/content/Context;Ljava/util/List;Ljava/util/List;IZ)V
    ...
    invoke-static {v1, v2}, Lae/q2;->d(Landroid/widget/ImageView;Landroid/widget/ImageView;)V
    ...
    .line 5
    :cond_3
    invoke-static {p1, p2}, Lae/q2;->f(Ljava/util/List;Ljava/util/List;)V
...
.method public static final f(Ljava/util/List;Ljava/util/List;)V
    ...
    .line 4
    invoke-static {p1, v1}, Lje/j;->w(Ljava/util/List;I)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lae/o2;

    if-eqz v5, :cond_0

    .line 5
    iget-object v5, v5, Lae/o2;->b:Ljava/lang/String;
    ...
    invoke-static {v9, v7}, Lt3/h;->b(Ljava/lang/Object;Ljava/lang/String;)V

    .line 7
    invoke-static {v9, v5, v8}, Lud/d0;->h(Landroid/widget/ImageView;Ljava/lang/String;Z)V
    ...
    check-cast v1, Lae/o2;

    if-eqz v1, :cond_2

    .line 9
    iget-object v4, v1, Lae/o2;->c:Ljava/lang/String;
    ...
    .line 11
    invoke-static {v1, v4, v8}, Lud/d0;->h(Landroid/widget/ImageView;Ljava/lang/String;Z)V
    ...
    .line 15
    iget-object v5, v5, Lae/o2;->d:Ljava/lang/String;
    ...
    .line 19
    iget-object v1, v1, Lae/o2;->e:Ljava/lang/String;
    ...
    .line 21
    invoke-static {v5, v1, v8}, Lud/d0;->h(Landroid/widget/ImageView;Ljava/lang/String;Z)V
...
.method public static final g(Landroid/content/Context;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 4
    invoke-static {p2, v3}, Lje/j;->w(Ljava/util/List;I)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Lae/o2;

    if-eqz v7, :cond_0

    .line 5
    iget-object v7, v7, Lae/o2;->a:Ljava/lang/String;
    ...
    .line 7
    invoke-static {v8, v7, v6}, Lud/d0;->j(Landroid/widget/TextView;Ljava/lang/String;Lre/p;)V
    ...
    invoke-static {v6}, Lcom/android/billingclient/api/b0;->l(Landroid/content/res/Resources;)Z
