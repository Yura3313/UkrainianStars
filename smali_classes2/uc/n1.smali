...
.method public static final e1(Luc/n1;)Luc/n1$a;
    .locals 1

    .line 1
    sget v0, Lcom/supercell/id/R$id;->list:I

    invoke-virtual {p0, v0}, Luc/n1;->d1(I)Landroid/view/View;
    ...
    :cond_0
    check-cast p0, Luc/n1$a;

    return-object p0
.end method

.method public static final f1(Luc/n1;)V
    .locals 2
...
.method public static final h1(Ljava/lang/String;Ljava/lang/String;II)Luc/n1;
    .locals 4
    ...
    .line 1
    new-instance v1, Luc/n1;

    invoke-direct {v1}, Luc/n1;-><init>()V
...
.method public Y0(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .line 5
    invoke-direct {p1, p0, v1, v0}, Luc/n1$k;-><init>(Luc/n1;Landroid/content/Context;I)V
    ...
    .line 10
    new-instance v0, Luc/n1$l;

    invoke-direct {v0, p1}, Luc/n1$l;-><init>(Lcom/google/android/material/bottomsheet/a;)V
...
.method public a0(Landroid/os/Bundle;)V
    ...
    invoke-static {v3}, Landroidx/savedstate/d;->s(Landroid/content/res/Resources;)Z
    ...
    invoke-virtual {p0, v3}, Luc/n1;->d1(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v1}, Luc/n1;->d1(I)Landroid/view/View;
    ...
    .line 21
    new-instance v2, Luc/n1$i;

    invoke-direct {v2, v1, p0}, Luc/n1$i;-><init>(Landroid/view/View;Luc/n1;)V
    ...
    .line 23
    new-instance v2, Luc/n1$j;

    invoke-direct {v2, v1, p0}, Luc/n1$j;-><init>(Landroid/widget/LinearLayout;Luc/n1;)V
...
.method public c0(Landroid/content/Context;)V
    ...
    .line 5
    :goto_0
    iput-object v0, p0, Luc/n1;->r0:Luc/n1$e;
...
.method public d1(I)Landroid/view/View;
    ...
    iget-object v0, p0, Luc/n1;->s0:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Luc/n1;->s0:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Luc/n1;->s0:Ljava/util/HashMap;
...
.method public final g1()V
    ...
    .line 7
    new-instance v1, Luc/n1$f;

    invoke-direct {v1, p0}, Luc/n1$f;-><init>(Luc/n1;)V
    ...
    .line 9
    :cond_0
    new-instance v0, Luc/n1$h;

    invoke-direct {v0, p0}, Luc/n1$h;-><init>(Luc/n1;)V
    ...
    .line 11
    new-instance v1, Luc/n1$g;

    invoke-direct {v1, v0, p0}, Luc/n1$g;-><init>(Landroid/widget/LinearLayout;Luc/n1;)V
...
.method public s0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, Luc/n1;->d1(I)Landroid/view/View;

    move-result-object v0

    if-eqz v0, :cond_0

    new-instance v1, Luc/n1$m;

    invoke-direct {v1, p0}, Luc/n1$m;-><init>(Luc/n1;)V
    ...
    new-instance v1, Luc/n1$n;

    invoke-direct {v1, p0}, Luc/n1$n;-><init>(Luc/n1;)V
    ...
    :goto_1
    invoke-direct {v1, p0, v3, v4}, Luc/n1$a;-><init>(Luc/n1;Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v5, Luc/p1;

    invoke-direct {v5, v3, v1, v4}, Luc/p1;-><init>(Landroid/widget/TextView;Luc/n1$a;Lle/r;)V
    ...
    invoke-static {v5, v7, v6}, Lcom/google/android/gms/ads/s;->c(Landroid/graphics/Path;Ljava/lang/Number;Ljava/lang/Number;)Landroid/graphics/Path;
    ...
    invoke-static {v5, v7, v6}, Lcom/google/android/gms/ads/s;->b(Landroid/graphics/Path;Ljava/lang/Number;Ljava/lang/Number;)Landroid/graphics/Path;
    ...
    invoke-direct {p1, v5, v6}, Lbe/g;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {p1, v2, p2, v3, v4}, Lsc/r;-><init>(Ljava/lang/String;FF[Lbe/g;)V
    ...
    new-instance v1, Luc/n1$o;

    invoke-direct {v1, p0, p2}, Luc/n1$o;-><init>(Luc/n1;Lsc/r;)V
    ...
    new-instance v0, Luc/n1$p;

    invoke-direct {v0, p0}, Luc/n1$p;-><init>(Luc/n1;)V
    ...
    new-instance p2, Luc/n1$q;

    invoke-direct {p2, p0}, Luc/n1$q;-><init>(Luc/n1;)V
