...
.method public a(Landroidx/recyclerview/widget/RecyclerView$z;Lm8/a0;)V
    ...
    .line 1
    check-cast p1, Lra/o0$b;

    check-cast p2, Lm8/w0;

    .line 2
    iget-object v0, p2, Lm8/u0;->z:Lm8/v0;

    .line 3
    iget-object v1, p1, Lra/o0$b;->y:Landroid/widget/TextView;
    ...
    .line 17
    :goto_0
    iget-object v7, p1, Lra/o0$b;->C:Landroid/view/View;

    invoke-virtual {v7, v3}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    .line 18
    iget-object v3, p1, Lra/o0$b;->z:Landroid/widget/TextView;

    invoke-virtual {v3, v2}, Landroid/widget/TextView;->setTextColor(I)V

    .line 19
    iget-object v2, p1, Lra/o0$b;->B:Landroid/widget/RelativeLayout;
    ...
    .line 20
    iget-object v2, p1, Lra/o0$b;->y:Landroid/widget/TextView;
    ...
    .line 22
    iget-object v2, p1, Lra/o0$b;->A:Landroid/widget/ImageView;

    invoke-virtual {p0, v2, v5}, Lra/v;->k(Landroid/view/View;Z)V

    .line 23
    iget-object v2, p2, Lm8/a0;->h:Lm8/o0;

    .line 24
    iget-object v3, p1, Lra/o0$b;->B:Landroid/widget/RelativeLayout;

    invoke-virtual {p0, v3, v2}, Lra/v;->i(Landroid/view/View;Lm8/o0;)V
    ...
    .line 27
    iget-boolean v0, v2, Lm8/o0;->a:Z

    .line 28
    invoke-virtual {p0, v3, v0}, Lra/v;->k(Landroid/view/View;Z)V

    if-eqz v5, :cond_5

    .line 29
    iget-object v0, p1, Lra/o0$b;->A:Landroid/widget/ImageView;
    ...
    iget-object v1, p1, Lra/o0$b;->D:Landroid/widget/RatingBar;
    ...
    .line 32
    iget-object p1, p1, Lra/o0$b;->D:Landroid/widget/RatingBar;

    iget p2, p2, Lm8/w0;->E:I
...
.method public b(Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    invoke-direct {v0, p0, p1}, Lra/o0$b;-><init>(Lra/o0;Landroid/view/View;)V

    .line 3
    iget-object p1, v0, Lra/o0$b;->B:Landroid/widget/RelativeLayout;
    ...
    .line 4
    iget-object p1, v0, Lra/o0$b;->y:Landroid/widget/TextView;
