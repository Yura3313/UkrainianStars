...
.method public final a(Landroidx/recyclerview/widget/RecyclerView$z;Lo8/z;)V
    ...
    .line 1
    check-cast p1, Lra/m0$a;

    check-cast p2, Lo8/u0;

    .line 2
    iget v0, p2, Lo8/t0;->A:I

    .line 3
    iget-object v1, p1, Lra/m0$a;->z:Landroid/widget/TextView;

    iget-object v2, p2, Lo8/z;->k:Ljava/lang/String;
    ...
    invoke-static {v1, v6}, Lcom/helpshift/util/e0;->b(Landroid/content/Context;I)I
    ...
    .line 17
    :goto_2
    iget-object v7, p1, Lra/m0$a;->D:Landroid/view/View;

    invoke-virtual {v7, v5}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    .line 18
    iget-object v5, p1, Lra/m0$a;->A:Landroid/widget/TextView;

    invoke-virtual {v5, v1}, Landroid/widget/TextView;->setTextColor(I)V

    .line 19
    iget-object v1, p1, Lra/m0$a;->C:Landroid/widget/RelativeLayout;
    ...
    .line 20
    iget-object v2, p1, Lra/m0$a;->z:Landroid/widget/TextView;
    ...
    .line 22
    iget-object v0, p1, Lra/m0$a;->B:Landroid/widget/ImageView;
    ...
    .line 24
    iget-object v2, p1, Lra/m0$a;->C:Landroid/widget/RelativeLayout;

    invoke-virtual {p0, v2, v0}, Lra/u;->j(Landroid/view/View;Lo8/n0;)V

    .line 25
    iget-object v2, p1, Lra/m0$a;->A:Landroid/widget/TextView;

    invoke-virtual {p0, v2, v0, v6}, Lra/u;->l(Landroid/widget/TextView;Lo8/n0;Ljava/lang/String;)V
    ...
    iget-object v1, p1, Lra/m0$a;->E:Landroid/widget/RatingBar;
    ...
    .line 29
    iget-object p1, p1, Lra/m0$a;->E:Landroid/widget/RatingBar;

    iget p2, p2, Lo8/u0;->F:I
...
.method public final b(Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    .line 2
    new-instance v0, Lra/m0$a;

    invoke-direct {v0, p0, p1}, Lra/m0$a;-><init>(Lra/m0;Landroid/view/View;)V

    .line 3
    iget-object p1, v0, Lra/m0$a;->C:Landroid/widget/RelativeLayout;
    ...
    .line 4
    iget-object p1, v0, Lra/m0$a;->z:Landroid/widget/TextView;
