...
.method public static final synthetic access$postFrameCallback(Landroid/view/Choreographer;Lpf/f;)V
    .locals 0

    invoke-static {p0, p1}, Lkotlinx/coroutines/android/HandlerDispatcherKt;->postFrameCallback(Landroid/view/Choreographer;Lpf/f;)V

    return-void
.end method

.method public static final synthetic access$updateChoreographerAndPostFrameCallback(Lpf/f;)V
    .locals 0

    invoke-static {p0}, Lkotlinx/coroutines/android/HandlerDispatcherKt;->updateChoreographerAndPostFrameCallback(Lpf/f;)V
...
.method public static final awaitFrame(Laf/d;)Ljava/lang/Object;
    .locals 3
    ...
    invoke-direct {v1, p0}, Lpf/g;-><init>(Laf/d;)V

    .line 3
    invoke-static {v0, v1}, Lkotlinx/coroutines/android/HandlerDispatcherKt;->access$postFrameCallback(Landroid/view/Choreographer;Lpf/f;)V

    .line 4
    invoke-virtual {v1}, Lpf/g;->n()Ljava/lang/Object;
    ...
    invoke-direct {v0, p0}, Lpf/g;-><init>(Laf/d;)V

    .line 6
    sget-object p0, Lpf/m0;->a:Lpf/v0;

    .line 7
    sget-object p0, Lqf/p;->a:Lpf/l1;
    ...
    invoke-direct {v2, v0}, Lkotlinx/coroutines/android/HandlerDispatcherKt$$special$$inlined$Runnable$1;-><init>(Lpf/f;)V

    .line 10
    invoke-virtual {p0, v1, v2}, Lpf/x;->dispatch(Laf/f;Ljava/lang/Runnable;)V
...
.method private static final postFrameCallback(Landroid/view/Choreographer;Lpf/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1}, Lkotlinx/coroutines/android/HandlerDispatcherKt$postFrameCallback$1;-><init>(Lpf/f;)V
...
.method private static final updateChoreographerAndPostFrameCallback(Lpf/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    :goto_0
    invoke-static {v0, p0}, Lkotlinx/coroutines/android/HandlerDispatcherKt;->postFrameCallback(Landroid/view/Choreographer;Lpf/f;)V
