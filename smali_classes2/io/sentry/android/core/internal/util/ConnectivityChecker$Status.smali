...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;

    const-string v3, "NOT_CONNECTED"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;->NOT_CONNECTED:Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;

    .line 3
    new-instance v3, Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;

    const-string v5, "NO_PERMISSION"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;->NO_PERMISSION:Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;

    .line 4
    new-instance v5, Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;

    const-string v7, "UNKNOWN"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;->UNKNOWN:Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;

    const/4 v7, 0x4

    new-array v7, v7, [Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;
    ...
    .line 5
    sput-object v7, Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;->$VALUES:[Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;
