...
.method public final onLayoutChange(Landroid/view/View;IIIIIIII)V
    ...
    invoke-static {p5, p4}, Lif/h;->b(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {p6, p4}, Lif/h;->b(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 4
    iget p4, p1, Lsc/d;->s:I

    if-ne p2, p4, :cond_0

    iget p4, p1, Lsc/d;->q:I

    if-ne p5, p4, :cond_0

    iget p4, p1, Lsc/d;->t:I

    if-ne p6, p4, :cond_0

    iget p4, p1, Lsc/d;->r:I

    if-eq p3, p4, :cond_1

    .line 5
    :cond_0
    iput p2, p1, Lsc/d;->s:I

    .line 6
    iput p5, p1, Lsc/d;->q:I

    .line 7
    iput p6, p1, Lsc/d;->t:I

    .line 8
    iput p3, p1, Lsc/d;->r:I
    ...
    invoke-virtual {p1, p2}, Lsc/d;->p(Landroid/graphics/Rect;)V
