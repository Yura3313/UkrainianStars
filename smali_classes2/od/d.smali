...
.field public final f0:Lie/g;

.field public final g0:Lie/g;

.field public final h0:Lie/g;

.field public i0:Z

.field public final j0:Lae/k;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lod/d;->d0:Ljava/util/LinkedHashSet;

    .line 3
    new-instance v0, Lae/n2;

    new-instance v1, Lod/d$j;

    invoke-direct {v1, p0}, Lod/d$j;-><init>(Lod/d;)V

    .line 4
    new-instance v2, Lod/d$k;

    invoke-direct {v2, p0}, Lod/d$k;-><init>(Lod/d;)V

    .line 5
    invoke-direct {v0, v1, v2}, Lae/n2;-><init>(Lre/l;Lre/l;)V

    iput-object v0, p0, Lod/d;->e0:Lae/n2;

    .line 6
    new-instance v0, Lod/d$f;

    invoke-direct {v0, p0}, Lod/d$f;-><init>(Lod/d;)V
    ...
    iput-object v0, p0, Lod/d;->f0:Lie/g;

    .line 7
    new-instance v0, Lod/d$c;

    invoke-direct {v0, p0}, Lod/d$c;-><init>(Lod/d;)V
    ...
    iput-object v0, p0, Lod/d;->g0:Lie/g;
    ...
    iput-object v0, p0, Lod/d;->h0:Lie/g;

    const/4 v0, 0x1

    .line 9
    iput-boolean v0, p0, Lod/d;->i0:Z
    ...
    iput-object v0, p0, Lod/d;->j0:Lae/k;

    return-void
.end method

.method public static final W0(Lod/d;Landroid/view/View;Landroid/view/View;Landroid/view/View;Lod/s;II)V
    .locals 7
    ...
    .line 3
    iget-object v1, p0, Lod/d;->f0:Lie/g;

    invoke-virtual {v1}, Lie/g;->getValue()Ljava/lang/Object;
    ...
    .line 7
    invoke-static {v6, v0}, Lt3/h;->d(II)I
    ...
    :cond_1
    invoke-static {v6, v1}, Lt3/h;->d(II)I
    ...
    .line 18
    invoke-virtual {p4, p5}, Lod/s;->a(F)V
    ...
    .line 23
    :goto_9
    iget-object p3, p0, Lod/d;->g0:Lie/g;

    invoke-virtual {p3}, Lie/g;->getValue()Ljava/lang/Object;
    ...
    .line 25
    iget-object p4, p0, Lod/d;->g0:Lie/g;

    invoke-virtual {p4}, Lie/g;->getValue()Ljava/lang/Object;
    ...
    .line 26
    invoke-static {p4}, Lcom/android/billingclient/api/y;->i(F)I

    move-result p4

    .line 27
    iget-object p5, p0, Lod/d;->f0:Lie/g;

    invoke-virtual {p5}, Lie/g;->getValue()Ljava/lang/Object;
    ...
    .line 32
    iget-object p0, p0, Lod/d;->h0:Lie/g;
    ...
    .line 33
    invoke-static {p0}, Lcom/android/billingclient/api/y;->i(F)I
...
.method public final N0()V
    ...
    iget-object v0, p0, Lod/d;->k0:Ljava/util/HashMap;
...
.method public final V0(I)Landroid/view/View;
    ...
    iput-object v0, p0, Lod/d;->k0:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lod/d;->k0:Ljava/util/HashMap;
...
.method public final X0()V
    ...
    iget-object v0, p0, Lod/d;->e0:Lae/n2;
    ...
    invoke-virtual {v1}, Lbe/h;->l()Lze/f0;

    move-result-object v1

    sget-object v2, Lod/d$e;->g:Lod/d$e;

    invoke-static {v1, v2}, Lae/t1;->p(Lze/f0;Lre/l;)Lze/f0;

    move-result-object v1

    invoke-virtual {v0, v1}, Lae/n2;->b(Lze/f0;)V
...
.method public final Y0(Ljava/util/List;)V
    ...
    .line 1
    iput-object p1, p0, Lod/d;->c0:Ljava/util/List;
    ...
    invoke-virtual {p0, v2}, Lod/d;->V0(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v0}, Lod/d;->V0(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v1}, Lod/d;->V0(I)Landroid/view/View;
...
.method public final Z0()V
    ...
    .line 1
    iget-object v0, p0, Lod/d;->c0:Ljava/util/List;
    ...
    .line 10
    iget-object v6, p0, Lod/d;->d0:Ljava/util/LinkedHashSet;
    ...
    invoke-virtual {p0, v6}, Lod/d;->V0(I)Landroid/view/View;
    ...
    .line 14
    invoke-static {v6, v0, v3, v1}, Lud/d0;->k(Landroid/widget/TextView;Ljava/lang/String;[Lie/d;Lre/l;)V
...
.method public final k0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p2}, Lod/d;->V0(I)Landroid/view/View;
    ...
    new-instance v0, Lod/d$g;

    invoke-direct {v0, p0}, Lod/d$g;-><init>(Lod/d;)V

    invoke-virtual {p2, v0}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 3
    :cond_0
    iget-object p2, p0, Lod/d;->c0:Ljava/util/List;
    ...
    iget-object v2, p0, Lod/d;->c0:Ljava/util/List;
    ...
    :goto_1
    invoke-direct {v1, p1, p0, v2}, Lod/d$b;-><init>(Landroid/content/Context;Lod/d;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1}, Lod/d;->V0(I)Landroid/view/View;
    ...
    invoke-direct {v1, v8, v0, p0}, Lod/g;-><init>(Landroid/view/View;ILod/d;)V

    invoke-virtual {p1, v1}, Landroid/view/View;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    .line 20
    new-instance v10, Lod/s;

    const-string v0, "selectAllBackground"

    invoke-static {v8, v0}, Lt3/h;->b(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v10, v0}, Lod/s;-><init>(Landroid/content/Context;)V
    ...
    .line 22
    invoke-virtual {v10, v0}, Lod/s;->a(F)V
    ...
    invoke-direct/range {v0 .. v5}, Lod/h;-><init>(Landroid/view/View;Landroid/view/View;Landroid/widget/FrameLayout;Lod/s;Lod/d;)V
    ...
    invoke-direct {v0, p2, v10}, Lod/i;-><init>(Ljava/lang/ref/WeakReference;Lod/s;)V

    invoke-static {p1, v0}, Lae/z2;->o(Landroid/view/View;Lae/w;)V

    .line 29
    invoke-virtual {p0}, Lod/d;->X0()V
    ...
    new-instance p2, Lod/d$h;

    invoke-direct {p2, p0}, Lod/d$h;-><init>(Lod/d;)V
    ...
    .line 35
    new-instance v0, Lod/d$i;

    invoke-direct {v0, p1}, Lod/d$i;-><init>(Ljava/lang/ref/WeakReference;)V
