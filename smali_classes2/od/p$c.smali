...
.method public constructor <init>(Lod/p;)V
    ...
    iput-object p1, p0, Lod/p$c;->g:Lod/p;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lod/p$c;->g:Lod/p;
    ...
    .line 7
    iget-object v4, p0, Lod/p$c;->g:Lod/p;
    ...
    .line 8
    invoke-static {v4, v5}, Lk3/gj;->a(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    iget-object v5, p0, Lod/p$c;->g:Lod/p;

    invoke-virtual {v5}, Landroidx/fragment/app/Fragment;->z0()Landroid/content/Context;

    move-result-object v5

    invoke-virtual {v4, v5}, Luc/o$c;->t(Landroid/content/Context;)Luc/o;

    move-result-object v4

    invoke-static {v0, v4, v1}, Lae/t2;->b(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/Rect;)V

    :cond_2
    if-eqz v0, :cond_3

    .line 11
    new-instance v4, Lod/p$c$a;

    invoke-direct {v4, p1, p0}, Lod/p$c$a;-><init>(Lcom/google/android/material/bottomsheet/a;Lod/p$c;)V
    ...
    invoke-virtual {v0, v4}, Luc/o$c;->i(Landroid/content/Context;)Luc/o;

    move-result-object v0

    invoke-static {v2, v0, v1}, Lae/t2;->b(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/Rect;)V

    :cond_4
    if-eqz v2, :cond_5

    .line 13
    new-instance v0, Lod/p$c$b;

    invoke-direct {v0, p1, p0}, Lod/p$c$b;-><init>(Lcom/google/android/material/bottomsheet/a;Lod/p$c;)V
    ...
    iget-object v2, p0, Lod/p$c;->g:Lod/p;

    invoke-virtual {v2}, Landroidx/fragment/app/Fragment;->z0()Landroid/content/Context;

    move-result-object v2

    invoke-virtual {v0, v2}, Luc/o$c;->h(Landroid/content/Context;)Luc/o;

    move-result-object v0

    invoke-static {v3, v0, v1}, Lae/t2;->b(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/Rect;)V

    :cond_6
    if-eqz v3, :cond_7

    .line 15
    new-instance v0, Lod/p$c$c;

    invoke-direct {v0, p1}, Lod/p$c$c;-><init>(Lcom/google/android/material/bottomsheet/a;)V
