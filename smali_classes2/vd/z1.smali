...
.method public static final varargs b(Landroid/view/View;Ljava/lang/String;[Lae/d;)V
    .locals 2
    ...
    .line 2
    new-instance v0, Lvd/z1$a;

    invoke-direct {v0, p1, p2}, Lvd/z1$a;-><init>(Ljava/lang/String;[Lae/d;)V

    invoke-virtual {p0, v0}, Lcom/supercell/id/view/SubPageTabLayout;->setGetTitleKey(Lke/l;)V

    .line 3
    new-instance v0, Lvd/z1$b;

    invoke-direct {v0, p1, p2}, Lvd/z1$b;-><init>(Ljava/lang/String;[Lae/d;)V
...
.method public static final c(Landroid/content/Context;Ljava/util/List;Lke/a;Landroidx/viewpager/widget/ViewPager;Lke/p;)V
    ...
    .line 1
    new-instance v1, Lvd/z1$d;

    invoke-direct {v1, p0, p1, p2}, Lvd/z1$d;-><init>(Landroid/content/Context;Ljava/util/List;Lke/a;)V
    ...
    .line 3
    new-instance v1, Lvd/z1$c;

    invoke-direct {v1, p2, p0, p4}, Lvd/z1$c;-><init>(Landroid/view/View;ILke/p;)V
...
.method public static final d(Landroid/widget/ImageView;I)V
    ...
    .line 1
    invoke-static {p0, p1}, Lvd/z1;->a(Landroid/widget/ImageView;I)Landroid/animation/Animator;
...
.method public static e(Landroid/widget/ImageView;Landroid/widget/ImageView;II)V
    ...
    .line 2
    invoke-static {p0, p2}, Lvd/z1;->a(Landroid/widget/ImageView;I)Landroid/animation/Animator;
    ...
    invoke-static {p1, p2}, Lvd/z1;->a(Landroid/widget/ImageView;I)Landroid/animation/Animator;
...
.method public static final f(Landroid/content/Context;Ljava/util/List;Ljava/util/List;IZ)V
    ...
    invoke-static {v2, v3, v1, v5}, Lvd/z1;->e(Landroid/widget/ImageView;Landroid/widget/ImageView;II)V
    ...
    .line 5
    :cond_3
    invoke-static {p1, p2}, Lvd/z1;->g(Ljava/util/List;Ljava/util/List;)V
...
.method public static final g(Ljava/util/List;Ljava/util/List;)V
    ...
    .line 4
    invoke-static {p1, v1}, Lbe/k;->G(Ljava/util/List;I)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lvd/x1;

    if-eqz v5, :cond_0

    .line 5
    iget-object v5, v5, Lvd/x1;->b:Ljava/lang/String;
    ...
    invoke-static {v9, v7}, Ls3/b;->c(Ljava/lang/Object;Ljava/lang/String;)V

    .line 7
    invoke-static {v9, v5, v8}, Lpd/d0;->h(Landroid/widget/ImageView;Ljava/lang/String;Z)V
    ...
    check-cast v1, Lvd/x1;

    if-eqz v1, :cond_2

    .line 9
    iget-object v4, v1, Lvd/x1;->c:Ljava/lang/String;
    ...
    .line 11
    invoke-static {v1, v4, v8}, Lpd/d0;->h(Landroid/widget/ImageView;Ljava/lang/String;Z)V
    ...
    .line 15
    iget-object v5, v5, Lvd/x1;->d:Ljava/lang/String;
    ...
    .line 19
    iget-object v1, v1, Lvd/x1;->e:Ljava/lang/String;
    ...
    .line 21
    invoke-static {v5, v1, v8}, Lpd/d0;->h(Landroid/widget/ImageView;Ljava/lang/String;Z)V
...
.method public static final h(Landroid/content/Context;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 4
    invoke-static {p2, v4}, Lbe/k;->G(Ljava/util/List;I)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Lvd/x1;

    if-eqz v7, :cond_0

    .line 5
    iget-object v7, v7, Lvd/x1;->a:Ljava/lang/String;
    ...
    .line 7
    invoke-static {v8, v7, v0}, Lpd/d0;->j(Landroid/widget/TextView;Ljava/lang/String;Lke/p;)V
    ...
    invoke-static {v7}, Lcom/android/billingclient/api/a0;->i(Landroid/content/res/Resources;)Z
