...
.method public constructor <init>(Ljava/util/List;)V
    ...
    iput-object p1, p0, Lvd/k1;->d:Ljava/util/List;

    .line 2
    new-instance p1, Lvd/k1$b;

    invoke-direct {p1}, Lvd/k1$b;-><init>()V

    iput-object p1, p0, Lvd/k1;->c:Lvd/k1$b;
...
.method public f(Landroidx/recyclerview/widget/RecyclerView$z;I)V
    ...
    .line 3
    iput-object v1, p1, Lvd/k1$a;->A:Lvd/j1;

    .line 4
    instance-of v2, v1, Lvd/j;

    if-eqz v2, :cond_0

    .line 5
    iget-object v0, p1, Lvd/k1$a;->B:Landroid/view/View;
    ...
    sget-object v8, Lpc/k$b;->h:Lpc/k$b;
    ...
    .line 6
    :cond_0
    instance-of v2, v1, Lvd/o;

    if-eqz v2, :cond_3

    .line 7
    iget-object v2, p1, Lvd/k1$a;->B:Landroid/view/View;
    ...
    .line 8
    iget-object v4, v3, Lvd/o;->b:Lcom/supercell/id/util/NormalizedError;
    ...
    .line 12
    iget-object v3, v3, Lvd/o;->b:Lcom/supercell/id/util/NormalizedError;
    ...
    new-array v6, v5, [Lae/d;

    .line 14
    iget-object v3, v3, Lcom/supercell/id/util/NormalizedError;->j:Lae/d;
    ...
    .line 19
    invoke-static {v2, v4, v3, v0}, Lpd/d0;->i(Landroid/widget/TextView;Ljava/lang/String;Ljava/util/Map;Lke/l;)V
    ...
    .line 21
    invoke-static {v2, v3, v0}, Lpd/d0;->j(Landroid/widget/TextView;Ljava/lang/String;Lke/p;)V

    goto :goto_1

    .line 22
    :cond_3
    instance-of v2, v1, Lvd/u;
    ...
    .line 24
    iget-object v3, v3, Lvd/u;->b:Ljava/lang/String;
    ...
    check-cast v3, Lvd/n1;

    .line 28
    iget-object v3, v3, Lvd/n1;->b:Ljava/lang/String;
    ...
    :cond_5
    :goto_1
    invoke-virtual {p0, p1, p2, v1}, Lvd/k1;->i(Lvd/k1$a;ILvd/j1;)V

    .line 31
    iget-object p2, p1, Lvd/k1$a;->z:Lke/p;

    if-eqz p2, :cond_6

    .line 32
    iget-object p2, p0, Lvd/k1;->c:Lvd/k1$b;
...
.method public bridge synthetic g(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lvd/k1;->j(Landroid/view/ViewGroup;I)Lvd/k1$a;
...
.method public h(Landroidx/recyclerview/widget/RecyclerView$z;)V
    ...
    .line 3
    iget-object v0, p0, Lvd/k1;->c:Lvd/k1$b;
...
.method public j(Landroid/view/ViewGroup;I)Lvd/k1$a;
    ...
    invoke-direct {v0, p1}, Lvd/k1$a;-><init>(Landroid/view/View;)V
