...
.method public static final varargs b(Landroid/view/View;Ljava/lang/String;[Lye/f;)V
    .locals 1
    ...
    .line 2
    new-instance v0, Lzd/m2$a;

    invoke-direct {v0, p1}, Lzd/m2$a;-><init>(Ljava/lang/String;)V

    invoke-virtual {p0, v0}, Lcom/supercell/id/view/SubPageTabLayout;->setGetTitleKey(Lhf/l;)V

    .line 3
    new-instance p1, Lzd/m2$b;

    invoke-direct {p1, p2}, Lzd/m2$b;-><init>([Lye/f;)V

    invoke-virtual {p0, p1}, Lcom/supercell/id/view/SubPageTabLayout;->setGetTitleReplacements(Lhf/l;)V
...
.method public static final c(Landroid/content/Context;Ljava/util/List;Lhf/a;Landroidx/viewpager/widget/ViewPager;Lhf/p;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    new-instance v0, Lzd/m2$d;

    invoke-direct {v0, p0, p1, p2}, Lzd/m2$d;-><init>(Landroid/content/Context;Ljava/util/List;Lhf/a;)V
    ...
    .line 3
    new-instance v0, Lzd/m2$c;

    invoke-direct {v0, p2, p0, p4}, Lzd/m2$c;-><init>(Landroid/view/View;ILhf/p;)V
...
.method public static d(Landroid/widget/ImageView;Landroid/widget/ImageView;)V
    ...
    .line 2
    invoke-static {p0, v0}, Lzd/m2;->a(Landroid/widget/ImageView;I)Landroid/animation/Animator;
...
.method public static final e(Landroid/content/Context;Ljava/util/List;Ljava/util/List;IZ)V
    ...
    invoke-static {v1, v2}, Lzd/m2;->d(Landroid/widget/ImageView;Landroid/widget/ImageView;)V
    ...
    .line 5
    :cond_3
    invoke-static {p1, p2}, Lzd/m2;->f(Ljava/util/List;Ljava/util/List;)V
...
.method public static final f(Ljava/util/List;Ljava/util/List;)V
    ...
    .line 4
    invoke-static {p1, v1}, Lze/j;->E(Ljava/util/List;I)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lzd/k2;

    if-eqz v5, :cond_0

    .line 5
    iget-object v5, v5, Lzd/k2;->b:Ljava/lang/String;
    ...
    .line 7
    invoke-static {v9, v5, v8}, Ltd/e0;->f(Landroid/widget/ImageView;Ljava/lang/String;Z)V
    ...
    check-cast v1, Lzd/k2;

    if-eqz v1, :cond_2

    .line 9
    iget-object v4, v1, Lzd/k2;->c:Ljava/lang/String;
    ...
    .line 11
    invoke-static {v1, v4, v8}, Ltd/e0;->f(Landroid/widget/ImageView;Ljava/lang/String;Z)V
    ...
    .line 17
    iget-object v5, v5, Lzd/k2;->d:Ljava/lang/String;
    ...
    .line 21
    iget-object v1, v1, Lzd/k2;->e:Ljava/lang/String;
    ...
    .line 23
    invoke-static {v5, v1, v8}, Ltd/e0;->f(Landroid/widget/ImageView;Ljava/lang/String;Z)V
...
.method public static final g(Landroid/content/Context;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 4
    invoke-static {p2, v3}, Lze/j;->E(Ljava/util/List;I)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Lzd/k2;

    if-eqz v7, :cond_0

    .line 5
    iget-object v7, v7, Lzd/k2;->a:Ljava/lang/String;
    ...
    .line 7
    invoke-static {v8, v7, v6}, Ltd/e0;->g(Landroid/widget/TextView;Ljava/lang/String;Lhf/p;)V
    ...
    invoke-static {v6}, Lcom/android/billingclient/api/v;->n(Landroid/content/res/Resources;)Z
