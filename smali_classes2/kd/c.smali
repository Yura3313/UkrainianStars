...
.field public final g0:Lbe/c;

.field public final h0:Lbe/c;

.field public i0:Z

.field public final j0:Lwd/j;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lkd/c;->d0:Ljava/util/Set;

    .line 3
    new-instance v0, Lwd/v1;

    new-instance v1, Lkd/c$j;

    invoke-direct {v1, p0}, Lkd/c$j;-><init>(Lkd/c;)V

    .line 4
    new-instance v2, Lkd/c$k;

    invoke-direct {v2, p0}, Lkd/c$k;-><init>(Lkd/c;)V

    .line 5
    invoke-direct {v0, v1, v2}, Lwd/v1;-><init>(Lke/l;Lke/l;)V

    iput-object v0, p0, Lkd/c;->e0:Lwd/v1;

    .line 6
    new-instance v0, Lkd/c$f;

    invoke-direct {v0, p0}, Lkd/c$f;-><init>(Lkd/c;)V

    invoke-static {v0}, Lbe/e;->f(Lke/a;)Lbe/c;

    move-result-object v0

    iput-object v0, p0, Lkd/c;->f0:Lbe/c;

    .line 7
    new-instance v0, Lkd/c$c;

    invoke-direct {v0, p0}, Lkd/c$c;-><init>(Lkd/c;)V

    invoke-static {v0}, Lbe/e;->f(Lke/a;)Lbe/c;

    move-result-object v0

    iput-object v0, p0, Lkd/c;->g0:Lbe/c;

    .line 8
    new-instance v0, Lkd/c$d;

    invoke-direct {v0, p0}, Lkd/c$d;-><init>(Lkd/c;)V

    invoke-static {v0}, Lbe/e;->f(Lke/a;)Lbe/c;

    move-result-object v0

    iput-object v0, p0, Lkd/c;->h0:Lbe/c;

    const/4 v0, 0x1

    .line 9
    iput-boolean v0, p0, Lkd/c;->i0:Z
    ...
    invoke-direct {v0, v1}, Lwd/j;-><init>(I)V

    iput-object v0, p0, Lkd/c;->j0:Lwd/j;

    return-void
.end method

.method public static final f1(Lkd/c;Landroid/view/View;Landroid/view/View;Landroid/view/View;Lkd/s;II)V
    .locals 7
    ...
    .line 3
    iget-object v1, p0, Lkd/c;->f0:Lbe/c;
    ...
    .line 7
    invoke-static {v6, v0}, Ly4/x;->g(II)I
    ...
    :cond_1
    invoke-static {v6, v1}, Ly4/x;->g(II)I
    ...
    .line 17
    invoke-static {p5}, Lc5/i;->c(I)F

    move-result p5

    mul-float p5, p5, v3

    invoke-virtual {p4, p5}, Lkd/s;->a(F)V
    ...
    .line 22
    :goto_9
    iget-object p3, p0, Lkd/c;->g0:Lbe/c;

    invoke-interface {p3}, Lbe/c;->getValue()Ljava/lang/Object;
    ...
    .line 24
    iget-object p4, p0, Lkd/c;->g0:Lbe/c;

    invoke-interface {p4}, Lbe/c;->getValue()Ljava/lang/Object;
    ...
    .line 25
    invoke-static {p4}, Lc2/n0;->e(F)I

    move-result p4

    .line 26
    iget-object p5, p0, Lkd/c;->f0:Lbe/c;

    invoke-interface {p5}, Lbe/c;->getValue()Ljava/lang/Object;
    ...
    .line 31
    iget-object p0, p0, Lkd/c;->h0:Lbe/c;
...
.method public W0()V
    ...
    iget-object v0, p0, Lkd/c;->k0:Ljava/util/HashMap;
...
.method public e1(I)Landroid/view/View;
    ...
    iput-object v0, p0, Lkd/c;->k0:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lkd/c;->k0:Ljava/util/HashMap;
...
.method public final g1()V
    ...
    .line 1
    iget-object v0, p0, Lkd/c;->e0:Lwd/v1;
    ...
    sget-object v2, Lkd/c$e;->a:Lkd/c$e;
...
.method public final h1(Ljava/util/List;)V
    ...
    .line 1
    iput-object p1, p0, Lkd/c;->c0:Ljava/util/List;
    ...
    invoke-virtual {p0, v2}, Lkd/c;->e1(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v0}, Lkd/c;->e1(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v1}, Lkd/c;->e1(I)Landroid/view/View;
...
.method public final i1()V
    ...
    .line 1
    iget-object v0, p0, Lkd/c;->c0:Ljava/util/List;
    ...
    .line 10
    iget-object v6, p0, Lkd/c;->d0:Ljava/util/Set;
    ...
    invoke-virtual {p0, v6}, Lkd/c;->e1(I)Landroid/view/View;
    ...
    invoke-direct {v7, v8, v2}, Lbe/g;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 14
    invoke-static {v6, v0, v3, v1}, Lqd/e0;->j(Landroid/widget/TextView;Ljava/lang/String;[Lbe/g;Lke/l;)V
...
.method public s0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p2}, Lkd/c;->e1(I)Landroid/view/View;
    ...
    new-instance v0, Lkd/c$g;

    invoke-direct {v0, p0}, Lkd/c$g;-><init>(Lkd/c;)V

    invoke-virtual {p2, v0}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 3
    :cond_0
    iget-object p2, p0, Lkd/c;->c0:Ljava/util/List;
    ...
    iget-object v2, p0, Lkd/c;->c0:Ljava/util/List;
    ...
    :goto_1
    invoke-direct {v1, p1, p0, v2}, Lkd/c$b;-><init>(Landroid/content/Context;Lkd/c;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1}, Lkd/c;->e1(I)Landroid/view/View;
    ...
    invoke-direct {v1, v8, v0, p0}, Lkd/f;-><init>(Landroid/view/View;ILkd/c;)V

    invoke-virtual {p1, v1}, Landroid/view/View;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    .line 18
    new-instance v10, Lkd/s;

    const-string v0, "selectAllBackground"

    invoke-static {v8, v0}, Ly4/x;->f(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v10, v0}, Lkd/s;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v10, v0}, Lkd/s;->a(F)V
    ...
    invoke-direct/range {v0 .. v5}, Lkd/g;-><init>(Landroid/view/View;Landroid/view/View;Landroid/widget/FrameLayout;Lkd/s;Lkd/c;)V
    ...
    invoke-direct {v0, p2, v10}, Lkd/h;-><init>(Ljava/lang/ref/WeakReference;Lkd/s;)V

    invoke-static {p1, v0}, Lwd/f2;->o(Landroid/view/View;Lwd/t;)V

    .line 26
    invoke-virtual {p0}, Lkd/c;->g1()V
    ...
    new-instance p2, Lkd/c$h;

    invoke-direct {p2, p0}, Lkd/c$h;-><init>(Lkd/c;)V
    ...
    .line 32
    new-instance v0, Lkd/c$i;

    invoke-direct {v0, p1}, Lkd/c$i;-><init>(Ljava/lang/ref/WeakReference;)V
