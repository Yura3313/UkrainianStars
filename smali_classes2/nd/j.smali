...
.method public constructor <init>()V
    ...
    .line 2
    new-instance v0, Lnd/j$b;

    invoke-direct {v0, p0}, Lnd/j$b;-><init>(Lnd/j;)V

    iput-object v0, p0, Lnd/j;->d0:Lke/l;
...
.method public W0()V
    ...
    iget-object v0, p0, Lnd/j;->g0:Ljava/util/HashMap;
...
.method public c1(I)Landroid/view/View;
    ...
    iput-object v0, p0, Lnd/j;->g0:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lnd/j;->g0:Ljava/util/HashMap;
...
.method public final e1(Lnd/m;)V
    .locals 8
    ...
    .line 1
    invoke-virtual {p1}, Lnd/m;->g()Lnd/m;
    ...
    .line 4
    iget-object v1, v1, Lnd/m$b;->f:Ljava/util/List;

    .line 5
    sget-object v3, Lnd/j$d;->g:Lnd/j$d;

    invoke-static {v1, v3}, Lbe/k;->R(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
    ...
    .line 9
    iget-object v5, v4, Lcom/supercell/id/model/IdConnectedSystem;->g:Ljava/lang/String;

    .line 10
    invoke-virtual {p1}, Lnd/m;->f()Lcom/supercell/id/model/IdPresenceStatus;
    ...
    invoke-direct {v6, v4, v5}, Lnd/i;-><init>(Lcom/supercell/id/model/IdConnectedSystem;Z)V
    ...
    invoke-virtual {v3}, Lbe/s;->hasNext()Z

    move-result v4

    if-eqz v4, :cond_5

    invoke-virtual {v3}, Lbe/s;->next()Ljava/lang/Object;
    ...
    .line 18
    iget v4, v3, Lbe/q;->a:I

    if-nez v4, :cond_3

    .line 19
    iget-object v3, v3, Lbe/q;->b:Ljava/lang/Object;
    ...
    new-array v4, v4, [Lvd/j1;

    sget-object v5, Lnd/l;->a:Lvd/j;
    ...
    .line 23
    :goto_4
    invoke-static {v1, v3}, Lbe/i;->z(Ljava/util/Collection;Ljava/lang/Iterable;)Z
    ...
    .line 24
    :cond_5
    iput-object v1, p0, Lnd/j;->f0:Ljava/util/List;
    ...
    invoke-virtual {p0, v3}, Lnd/j;->c1(I)Landroid/view/View;
    ...
    invoke-virtual {p0, p1}, Lnd/j;->c1(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, Lnd/j;->c1(I)Landroid/view/View;
    ...
    invoke-virtual {v0, v1}, Lvd/q;->k(Ljava/util/List;)V
...
.method public i0()V
    ...
    iget-object v1, p0, Lnd/j;->d0:Lke/l;
...
.method public s0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 1
    invoke-virtual {p0}, Lnd/j;->d1()Lcom/supercell/id/ui/publicprofile/PublicProfileFragment;
    ...
    .line 2
    iget-object p2, p1, Lcom/supercell/id/ui/publicprofile/PublicProfileFragment;->n0:Lnd/m;

    .line 3
    :cond_0
    invoke-virtual {p0, p2}, Lnd/j;->e1(Lnd/m;)V
    ...
    new-instance p2, Lnd/j$a;

    iget-object v0, p0, Lnd/j;->f0:Ljava/util/List;
    ...
    :goto_0
    invoke-direct {p2, p0, v0}, Lnd/j$a;-><init>(Lnd/j;Ljava/util/List;)V
    ...
    .line 11
    new-instance v0, Lnd/j$c;

    invoke-direct {v0, p0, p1}, Lnd/j$c;-><init>(Lnd/j;I)V
    ...
    iget-object p2, p0, Lnd/j;->d0:Lke/l;
