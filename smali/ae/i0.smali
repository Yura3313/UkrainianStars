...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lae/i0;->o:Landroid/content/Context;
    ...
    iput-object v0, p0, Lae/i0;->f:Ljava/util/LinkedHashSet;
    ...
    iput-object v0, p0, Lae/i0;->g:Ljava/util/LinkedHashSet;
    ...
    iput-object v0, p0, Lae/i0;->h:Ljava/util/LinkedHashSet;

    .line 5
    sget-object v0, Lae/i0$a;->f:Lae/i0$a;
    ...
    iput-object v0, p0, Lae/i0;->i:Lie/f;
    ...
    iput-object v0, p0, Lae/i0;->l:Ljava/util/LinkedList;
    ...
    .line 10
    :cond_1
    iput-object v2, p0, Lae/i0;->n:Ljava/util/Date;

    .line 11
    new-instance p1, Lae/j0;

    invoke-direct {p1, p0}, Lae/j0;-><init>(Lae/i0;)V
...
# virtual methods
.method public final a(Ljava/lang/String;Lvc/y;)V
    .locals 6
    ...
    .line 1
    iget-object v0, p0, Lae/i0;->m:Ljava/lang/ref/WeakReference;
    ...
    .line 2
    iget-object v1, v0, Lid/w;->g:Ljava/util/ArrayList;
    ...
    .line 7
    iget-object v5, v3, Lid/i;->i:Lvc/n$j$c;

    .line 8
    iget-object v5, v5, Lvc/n$j$c;->h:Lvc/x;
    ...
    .line 18
    :cond_5
    instance-of p2, p2, Lvc/y$e;

    if-nez p2, :cond_a

    .line 19
    iget-object p2, v0, Lid/w;->f:Ljava/util/LinkedList;
    ...
    .line 22
    check-cast v2, Lvc/n$j;

    .line 23
    instance-of v3, v2, Lvc/n$j$c;
    ...
    :cond_7
    check-cast v2, Lvc/n$j$c;

    if-eqz v2, :cond_8

    .line 24
    iget-object v3, v2, Lvc/n$j$c;->h:Lvc/x;

    .line 25
    iget-object v3, v3, Lvc/x;->a:Ljava/lang/String;

    .line 26
    invoke-static {v3, p1}, Lt3/e;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    check-cast p2, Lvc/n$j$c;

    .line 29
    iget-object v1, v0, Lid/w;->f:Ljava/util/LinkedList;
...
.method public final b()V
    ...
    .line 1
    iget-object v0, p0, Lae/i0;->l:Ljava/util/LinkedList;
...
.method public final c(Landroid/app/Activity;Lvc/n;)V
    .locals 9
    ...
    .line 1
    iget-object v0, p2, Lvc/n;->d:Ljava/util/Date;
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p2}, Lae/i0;->h(Lvc/n;)Z
    ...
    check-cast v1, Lvc/n$f;

    .line 6
    iget-object v1, v1, Lvc/n$f;->g:Lcom/supercell/id/IdFriend;
    ...
    invoke-virtual {v2, v4}, Lbe/v0;->a(Lbe/a;)V
    ...
    check-cast v2, Lvc/n$h;

    .line 15
    iget-object v2, v2, Lvc/n$h;->g:Lcom/supercell/id/model/IdSocialAccount;
    ...
    check-cast v3, Lvc/n$g;

    .line 22
    iget-object v3, v3, Lvc/n$g;->g:Lcom/supercell/id/model/IdSocialAccount;
    ...
    invoke-virtual {v2, v1}, Lbe/v0;->a(Lbe/a;)V
    ...
    check-cast v2, Lvc/n$e;

    .line 30
    iget-object v2, v2, Lvc/n$e;->g:Lcom/supercell/id/model/IdSocialAccount;
    ...
    invoke-virtual {v1, v3}, Lbe/v0;->a(Lbe/a;)V
    ...
    check-cast v0, Lvc/n$j$d;

    .line 39
    iget-object v3, v0, Lvc/n$j$d;->k:Lae/m;
    ...
    .line 41
    iget-object v5, v0, Lvc/n$j$d;->h:Lcom/supercell/id/model/IdSocialAccount;

    .line 42
    iget-object v6, v0, Lvc/n$j$d;->i:Ljava/lang/String;

    .line 43
    iget-object v0, v0, Lvc/n$j$d;->j:Lcom/supercell/id/model/ProfileImage;

    .line 44
    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    .line 45
    invoke-static {v5, v1}, Lt3/e;->c(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v1}, Lbe/v0;->a(Lbe/a;)V
    ...
    check-cast v2, Lvc/n$c;

    .line 51
    iget-object v2, v2, Lvc/n$c;->g:Ljava/lang/String;
    ...
    .line 54
    new-instance v1, Lbe/o0$b$h;

    invoke-direct {v1, v2}, Lbe/o0$b$h;-><init>(Ljava/lang/String;)V
    ...
    check-cast v2, Lvc/n$d;

    .line 57
    iget-object v2, v2, Lvc/n$d;->g:Ljava/lang/String;
    ...
    .line 60
    new-instance v1, Lbe/o0$b$k;

    invoke-direct {v1, v2}, Lbe/o0$b$k;-><init>(Ljava/lang/String;)V
    ...
    .line 66
    new-instance v2, Lbe/o0$b$i;

    invoke-direct {v2, v1}, Lbe/o0$b$i;-><init>(Lvc/x;)V
    ...
    check-cast v1, Lvc/n$j$i;

    .line 69
    iget-object v3, v1, Lvc/n$j$i;->j:Ljava/util/List;
    ...
    .line 72
    new-instance v4, Lbe/o0$b$l;

    invoke-direct {v4, v3}, Lbe/o0$b$l;-><init>(Ljava/util/List;)V

    invoke-virtual {v0, v4}, Lbe/v0;->a(Lbe/a;)V

    .line 73
    iget-object v0, v1, Lvc/n$j$i;->j:Ljava/util/List;

    .line 74
    iget-object v3, v1, Lvc/n$j$i;->h:Lvc/a0;
    ...
    .line 77
    iget-object v7, v7, Lvc/x;->d:Ljava/util/List;
    ...
    .line 98
    iget-object v1, v1, Lvc/n$j$i;->k:Ljava/lang/String;
    ...
    check-cast v1, Lvc/n$i;

    .line 103
    iget-object v1, v1, Lvc/n$i;->g:Lcom/supercell/id/model/IdSocialAccount;
    ...
    :cond_16
    :goto_5
    instance-of v0, p2, Lvc/n$j;

    if-eqz v0, :cond_18

    .line 106
    iget-boolean v0, p0, Lae/i0;->k:Z
    ...
    check-cast v0, Lvc/n$j;

    invoke-virtual {p0, p1, v0}, Lae/i0;->d(Landroid/app/Activity;Lvc/n$j;)Lze/e0;

    move-result-object p1

    new-instance v0, Lae/i0$b;

    invoke-direct {v0, p0, p2}, Lae/i0$b;-><init>(Lae/i0;Lvc/n;)V
    ...
    .line 108
    :cond_17
    iget-object p1, p0, Lae/i0;->l:Ljava/util/LinkedList;
...
.method public final d(Landroid/app/Activity;Lvc/n$j;)Lze/e0;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    :cond_0
    iget-object p1, p2, Lvc/n;->e:Ljava/util/Date;
    ...
    .line 10
    :goto_0
    new-instance v1, Lae/i0$c;

    invoke-direct {v1, p0, p2}, Lae/i0$c;-><init>(Lae/i0;Lvc/n$j;)V

    .line 11
    sget-object v2, Lze/u0;->f:Lze/u0;

    sget-object v3, Lze/k0;->a:Lze/t0;

    .line 12
    sget-object v3, Laf/q;->a:Lze/i1;
    ...
    invoke-direct {v4, p1, v1, v5}, Lae/x1;-><init>(Lze/e0;Lre/l;Lke/d;)V

    const/4 p1, 0x2

    invoke-static {v2, v3, v4, p1}, La5/g0;->j(Lze/a0;Lke/f;Lre/p;I)Lze/e0;

    move-result-object p1

    .line 14
    new-instance v1, Lae/i0$d;

    invoke-direct {v1, p0, p2, v0}, Lae/i0$d;-><init>(Lae/i0;Lvc/n$j;Ljava/lang/ref/WeakReference;)V

    invoke-static {p1, v1}, Lae/u1;->r(Lze/e0;Lre/l;)Lze/e0;
...
.method public final e(Lcom/supercell/id/model/IdSocialAccount;Lcom/supercell/id/model/IdRelationshipStatus;)V
    ...
    .line 7
    iget-object v5, v3, Lid/o;->j:Lvc/n$j$d;

    .line 8
    iget-object v5, v5, Lvc/n$j$d;->h:Lcom/supercell/id/model/IdSocialAccount;
    ...
    :cond_9
    check-cast v2, Lvc/n$j$d;

    if-eqz v2, :cond_a

    .line 22
    iget-object v3, v2, Lvc/n$j$d;->h:Lcom/supercell/id/model/IdSocialAccount;
...
.method public final f(Lvc/t;)V
    ...
    invoke-virtual {p1}, Lvc/t;->a()Lcom/supercell/id/model/IdSocialAccount;

    move-result-object v0

    invoke-virtual {p1}, Lvc/t;->b()Lcom/supercell/id/model/IdRelationshipStatus;

    move-result-object p1

    invoke-virtual {p0, v0, p1}, Lae/i0;->e(Lcom/supercell/id/model/IdSocialAccount;Lcom/supercell/id/model/IdRelationshipStatus;)V
...
.method public final g(Landroid/app/Activity;)V
    ...
    new-instance v1, Lae/i0$g;

    invoke-direct {v1}, Lae/i0$g;-><init>()V

    invoke-static {v0, v1}, Lje/g;->t(Ljava/util/List;Ljava/util/Comparator;)V
    ...
    new-instance v2, Lae/i0$e;

    invoke-direct {v2, v0, p0, p1}, Lae/i0$e;-><init>(Lvc/n$j;Lae/i0;Landroid/app/Activity;)V

    invoke-static {v1, v2}, Lae/u1;->m(Lze/e0;Lre/l;)Lze/e0;

    .line 6
    new-instance v2, Lae/i0$f;

    invoke-direct {v2, v0, p0, p1}, Lae/i0$f;-><init>(Lvc/n$j;Lae/i0;Landroid/app/Activity;)V
...
.method public final h(Lvc/n;)Z
    .locals 2

    .line 1
    iget-object v0, p1, Lvc/n;->a:Ljava/lang/String;
    ...
    .line 5
    :cond_0
    iget-object p1, p1, Lvc/n;->b:Ljava/lang/String;
