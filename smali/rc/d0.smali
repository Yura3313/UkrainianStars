...
.method public final g(Ljava/util/List;)Lze/f0;
    ...
    .line 2
    invoke-static {p1, v0}, Lje/j;->q(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    invoke-static {v0, v9}, Lje/f;->l(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v2, v9}, Lje/f;->l(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v0, v1}, Lae/t1;->e(Lze/f0;Lre/l;)Lze/f0;
    ...
    invoke-direct {v2, v8, v1}, Lae/s1;-><init>(Ljava/util/Collection;Lke/d;)V

    const/4 v3, 0x3

    invoke-static {v0, v1, v2, v3}, La5/b0;->b(Lze/a0;Lke/f;Lre/p;I)Lze/f0;

    move-result-object v0

    .line 30
    sget-object v1, Lrc/d0$e;->g:Lrc/d0$e;
...
.method public final h(Ljava/lang/String;Z)Lze/f0;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    invoke-virtual {p0, p2, p1, v0}, Lrc/f;->d(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;)Lze/f0;
    ...
    .line 7
    sget-object v0, Lrc/d0$g;->h:Lrc/d0$g;
    ...
    invoke-direct {v0, p1}, Lrc/d0$h;-><init>(Lze/f0;)V

    invoke-static {p2, v0}, Lae/t1;->g(Lze/f0;Lre/l;)Lze/f0;

    return-object p2
.end method

.method public final i(Ljava/lang/String;)Lze/f0;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    sget-object v0, Lrc/d0$j;->h:Lrc/d0$j;
...
.method public final j(Ljava/util/List;)Lze/f0;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, p1, p1, v1}, Lrc/d0;->q(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Lre/l;)Lze/f0;
...
.method public final k()Lze/f0;
    ...
    .line 3
    sget-object v1, Lrc/d0$m;->h:Lrc/d0$m;
...
.method public final l(Lcom/supercell/id/model/IdSocialAccount;)Lze/f0;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 10
    invoke-static {v0}, La5/b0;->k([Lie/d;)Ljava/util/Map;
    ...
    .line 13
    sget-object v0, Lrc/d0$o;->h:Lrc/d0$o;
...
.method public final m(Ljava/lang/String;)Lze/f0;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    invoke-virtual {p0, v0, p1, v1}, Lrc/f;->d(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;)Lze/f0;
    ...
    .line 5
    sget-object v1, Lrc/d0$q;->h:Lrc/d0$q;
    ...
    invoke-direct {v1, p1}, Lrc/d0$r;-><init>(Lze/f0;)V

    invoke-static {v0, v1}, Lae/t1;->g(Lze/f0;Lre/l;)Lze/f0;

    return-object v0
.end method

.method public final n(Ljava/lang/String;)Lze/f0;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    sget-object v0, Lrc/d0$t;->h:Lrc/d0$t;
...
.method public final o(Ljava/util/List;)Lze/f0;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-virtual {p0, v0, p1}, Lrc/d0;->p(Ljava/util/List;Ljava/lang/String;)Lze/f0;
...
.method public final p(Ljava/util/List;Ljava/lang/String;)Lze/f0;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    :cond_0
    sget-object v0, Lrc/d0$u;->g:Lrc/d0$u;

    const-string v1, "FULL"

    invoke-virtual {p0, p1, v1, p2, v0}, Lrc/d0;->q(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Lre/l;)Lze/f0;
...
.method public final q(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Lre/l;)Lze/f0;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 14
    invoke-virtual {v9}, Lcom/supercell/id/model/IdSocialAccount;->a()Lvc/d;
    ...
    invoke-static {v8, v3}, Lje/f;->l(Ljava/lang/Iterable;I)I
    ...
    .line 21
    invoke-virtual {v9}, Lvc/d;->a()Ljava/lang/String;
    ...
    .line 24
    invoke-static {v4}, La5/b0;->k([Lie/d;)Ljava/util/Map;
    ...
    .line 25
    invoke-virtual {p0, v5, v4, p3}, Lrc/f;->d(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;)Lze/f0;
    ...
    .line 27
    sget-object v5, Lrc/d0$w;->g:Lrc/d0$w;
    ...
    invoke-direct {p2, v0, v6}, Lae/s1;-><init>(Ljava/util/Collection;Lke/d;)V

    invoke-static {p1, v6, p2, v5}, La5/b0;->b(Lze/a0;Lke/f;Lre/p;I)Lze/f0;

    move-result-object p1

    .line 29
    invoke-static {p1, p4}, Lae/t1;->o(Lze/f0;Lre/l;)Lze/f0;
...
.method public final r(Ljava/lang/String;Ljava/lang/String;)Lze/f0;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-static {v2}, Lje/t;->l([Lie/d;)Ljava/util/Map;
    ...
    invoke-static/range {v3 .. v8}, Lrc/f;->e(Lrc/f;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;ILjava/lang/Object;)Lze/f0;

    move-result-object p1

    .line 3
    new-instance p2, Lrc/d0$x;

    invoke-direct {p2, p0}, Lrc/d0$x;-><init>(Lrc/d0;)V
    ...
    .line 4
    sget-object p2, Lrc/d0$y;->g:Lrc/d0$y;
...
.method public final s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;)Lze/f0;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 9
    new-instance p2, Lrc/d0$z;

    invoke-direct {p2, p0}, Lrc/d0$z;-><init>(Lrc/d0;)V
    ...
    .line 10
    sget-object p2, Lrc/d0$a0;->g:Lrc/d0$a0;
...
.method public final t(Lcom/supercell/id/model/IdSocialAccount;Ljava/lang/String;)Lze/f0;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 12
    new-instance p2, Lrc/d0$b0;

    invoke-direct {p2, p0}, Lrc/d0$b0;-><init>(Lrc/d0;)V
    ...
    .line 13
    sget-object p2, Lrc/d0$c0;->g:Lrc/d0$c0;
...
.method public final u(Landroid/graphics/Bitmap;)Lze/f0;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 8
    new-instance v0, Lrc/d0$d0;

    invoke-direct {v0, p0}, Lrc/d0$d0;-><init>(Lrc/d0;)V
    ...
    .line 9
    sget-object v1, Lrc/d0$e0;->h:Lrc/d0$e0;
    ...
    .line 10
    new-instance v1, Lrc/d0$f0;

    invoke-direct {v1, p1}, Lrc/d0$f0;-><init>(Lze/f0;)V
    ...
    invoke-static {v0, p1}, Le0/f;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    throw v1
.end method

.method public final v(Ljava/lang/String;)Lze/f0;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0}, Lrc/d0$g0;-><init>(Lrc/d0;)V
    ...
    invoke-direct {v1, p1}, Lrc/d0$h0;-><init>(Ljava/lang/String;)V
