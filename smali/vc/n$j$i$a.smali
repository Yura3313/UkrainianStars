.class public final Lvc/n$j$i$a;
...
# virtual methods
.method public final a(Lcom/supercell/websocket/proxy/protocol/notifications/store/NotificationPurchasesReceived;Lvc/n$a;)Lvc/n$j$i;
    .locals 10
    ...
    invoke-direct {v1, v2}, Lvc/a0;-><init>(Lcom/supercell/websocket/proxy/protocol/notifications/store/IdShopProduct;)V
    :try_end_0
    ...
    invoke-direct {v2, v1}, Lvc/x;-><init>(Lcom/supercell/websocket/proxy/protocol/notifications/store/IdShopItem;)V
    :try_end_1
    ...
    .line 10
    :cond_3
    new-instance p1, Lvc/n$j$i;

    move-object v4, p1

    move-object v9, p2

    invoke-direct/range {v4 .. v9}, Lvc/n$j$i;-><init>(Lvc/a0;ILjava/util/List;Ljava/lang/String;Lvc/n$a;)V
