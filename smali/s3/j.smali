...
.method public r(Ljava/lang/Iterable;)La2/a0;
    ...
    invoke-virtual {p0, v2}, Ls3/j;->D(I)V

    .line 4
    instance-of v1, v0, Ls3/l;
    ...
    invoke-virtual {v0, p1, v1}, Ls3/l;->a([Ljava/lang/Object;I)I

    move-result p1

    iput p1, p0, Ls3/j;->b:I

    return-object p0

    .line 7
    :cond_0
    invoke-super {p0, p1}, La2/a0;->r(Ljava/lang/Iterable;)La2/a0;
