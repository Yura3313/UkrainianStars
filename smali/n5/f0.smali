...
# static fields
.field private static final DEFAULT_INSTANCE:Ln5/f0;
...
# instance fields
.field private demParams_:Ln5/d0;

.field private ecPointFormat_:I

.field private kemParams_:Ln5/i0;
...
.method public static constructor <clinit>()V
    ...
    .line 2
    sput-object v0, Ln5/f0;->DEFAULT_INSTANCE:Ln5/f0;
...
.method public static synthetic q()Ln5/f0;
    .locals 1

    sget-object v0, Ln5/f0;->DEFAULT_INSTANCE:Ln5/f0;

    return-object v0
.end method

.method public static r()Ln5/f0;
    .locals 1
...
.method public final i(Lcom/google/crypto/tink/shaded/protobuf/n$f;)Ljava/lang/Object;
    ...
    .line 3
    :pswitch_0
    sget-object p1, Ln5/f0;->PARSER:Lo5/u;

    if-nez p1, :cond_1

    .line 4
    const-class v0, Ln5/f0;
    ...
    .line 9
    :pswitch_1
    sget-object p1, Ln5/f0;->DEFAULT_INSTANCE:Ln5/f0;

    return-object p1

    .line 10
    :pswitch_2
    new-instance p1, Ln5/f0$a;

    invoke-direct {p1}, Ln5/f0$a;-><init>()V
    ...
    invoke-direct {p1}, Ln5/f0;-><init>()V
...
.method public final s()Ln5/d0;
    .locals 1

    iget-object v0, p0, Ln5/f0;->demParams_:Ln5/d0;

    if-nez v0, :cond_0

    invoke-static {}, Ln5/d0;->s()Ln5/d0;
...
.method public final t()Ln5/x;
    .locals 1

    .line 1
    iget v0, p0, Ln5/f0;->ecPointFormat_:I

    invoke-static {v0}, Ln5/x;->c(I)Ln5/x;
...
.method public final u()Ln5/i0;
    .locals 1

    iget-object v0, p0, Ln5/f0;->kemParams_:Ln5/i0;

    if-nez v0, :cond_0

    invoke-static {}, Ln5/i0;->s()Ln5/i0;
