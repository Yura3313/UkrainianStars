...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lud/f0;->a:Ljava/util/Map;
    ...
    sput-object v0, Lud/f0;->b:Ljava/util/Map;
    ...
    sput-object v0, Lud/f0;->c:Ljava/util/Map;
...
.method public static final a(Landroid/widget/ImageView;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 3
    invoke-static {p0, p1, p4}, Lud/f0;->e(Landroid/widget/ImageView;Ljava/lang/String;Z)V

    return-void

    .line 4
    :cond_1
    new-instance p3, Lud/f0$c;

    invoke-direct {p3, v0, p4, p1}, Lud/f0$c;-><init>(Ljava/lang/ref/WeakReference;ZLjava/lang/String;)V

    .line 5
    sget-object p1, Lud/f0;->c:Ljava/util/Map;
    ...
    new-instance v4, Lud/f0$a;

    invoke-direct {v4, p3, v0, v1}, Lud/f0$a;-><init>(Lud/f0$c;J)V

    .line 8
    new-instance v5, Lud/f0$b;

    invoke-direct {v5, p3}, Lud/f0$b;-><init>(Lud/f0$c;)V
...
.method public static final c(Landroid/widget/TextView;)V
    ...
    const-string v0, "$this$clearPendingTextKey"

    invoke-static {p0, v0}, Lt3/e;->c(Ljava/lang/Object;Ljava/lang/String;)V

    sget-object v0, Lud/f0;->a:Ljava/util/Map;
...
.method public static final e(Landroid/widget/ImageView;Ljava/lang/String;Z)V
    ...
    invoke-direct {v2, v0, p1, p2}, Lud/d0;-><init>(Ljava/lang/ref/WeakReference;Lae/e;Z)V
    ...
    .line 6
    iget-object p0, p0, Lae/u;->s:Lud/j;

    const-string p1, "portraits.png"

    .line 7
    invoke-virtual {p0, p1, v2}, Lud/j;->b(Ljava/lang/String;Lre/p;)V

    goto :goto_1

    .line 8
    :cond_1
    new-instance p1, Lud/e0;

    invoke-direct {p1, v0, p2}, Lud/e0;-><init>(Ljava/lang/ref/WeakReference;Z)V

    .line 9
    sget-object p2, Lud/f0;->c:Ljava/util/Map;
    ...
    .line 12
    invoke-virtual {p0, p2, p1}, Lud/j;->b(Ljava/lang/String;Lre/p;)V
...
.method public static final f(Landroid/widget/EditText;Ljava/lang/String;)V
    ...
    .line 2
    new-instance v1, Lud/f0$d;

    invoke-direct {v1, v0}, Lud/f0$d;-><init>(Ljava/lang/ref/WeakReference;)V

    .line 3
    sget-object v0, Lud/f0;->b:Ljava/util/Map;
    ...
    .line 6
    invoke-virtual {p0, p1, v1}, Lud/j;->e(Ljava/lang/String;Lre/l;)V
...
.method public static g(Landroid/widget/ImageView;Lcom/supercell/id/model/ProfileImage;)V
    ...
    .line 5
    :goto_2
    invoke-static {p0, v1, p1, v2, v0}, Lud/f0;->a(Landroid/widget/ImageView;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public static final h(Landroid/widget/ImageView;Ljava/lang/String;Z)V
    ...
    .line 2
    new-instance v1, Lud/f0$e;

    invoke-direct {v1, v0, p2}, Lud/f0$e;-><init>(Ljava/lang/ref/WeakReference;Z)V
    ...
    .line 6
    invoke-virtual {p0, p1, v1}, Lud/j;->b(Ljava/lang/String;Lre/p;)V
...
.method public static final i(Landroid/widget/TextView;Ljava/lang/String;Ljava/util/Map;Lre/l;)V
    ...
    new-instance v0, Lud/f0$f;

    invoke-direct {v0, p2, p3}, Lud/f0$f;-><init>(Ljava/util/Map;Lre/l;)V
...
.method public static final j(Landroid/widget/TextView;Ljava/lang/String;Lre/p;)V
    ...
    .line 2
    new-instance v1, Lud/f0$g;

    invoke-direct {v1, v0, p2}, Lud/f0$g;-><init>(Ljava/lang/ref/WeakReference;Lre/p;)V

    .line 3
    sget-object p2, Lud/f0;->a:Ljava/util/Map;
...
.method public static final k(Landroid/widget/TextView;Ljava/lang/String;[Lie/d;Lre/l;)V
    ...
    invoke-static {p2}, Lje/t;->r([Lie/d;)Ljava/util/Map;

    move-result-object p2

    invoke-static {p0, p1, p2, p3}, Lud/f0;->i(Landroid/widget/TextView;Ljava/lang/String;Ljava/util/Map;Lre/l;)V
...
.method public static final l(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    sget-object v0, Lud/f0$h;->f:Lud/f0$h;
...
.method public static final m(Landroid/widget/TextView;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-direct {v0, p2}, Lud/m0;-><init>(Ljava/lang/Object;)V
...
.method public static final n(Landroid/widget/TextView;Ljava/util/Date;)V
    ...
    .line 12
    invoke-static {p0, p1, v0, v1}, Lud/f0;->i(Landroid/widget/TextView;Ljava/lang/String;Ljava/util/Map;Lre/l;)V
...
.method public static final o(Landroid/widget/TextView;Ljava/lang/String;Ljava/lang/String;Lre/p;)V
    ...
    new-instance v0, Lud/f0$i;

    invoke-direct {v0, p3, p2}, Lud/f0$i;-><init>(Lre/p;Ljava/lang/String;)V
...
.method public static p(Lcom/google/android/material/imageview/ShapeableImageView;Ljava/lang/String;)V
    ...
    .line 3
    invoke-static {p0, v2, v0}, Lud/f0;->e(Landroid/widget/ImageView;Ljava/lang/String;Z)V
    ...
    invoke-direct {v2, v1, v0}, Lud/i0;-><init>(Ljava/lang/ref/WeakReference;Z)V

    .line 5
    sget-object v0, Lud/f0;->c:Ljava/util/Map;
    ...
    invoke-virtual {v3, p1}, Lae/b0;->a(Ljava/lang/String;)Lze/e0;

    move-result-object v4

    new-instance v6, Lud/g0;

    invoke-direct {v6, v2, v0, v1}, Lud/g0;-><init>(Lud/i0;J)V

    .line 8
    new-instance v7, Lud/h0;

    invoke-direct {v7, v2}, Lud/h0;-><init>(Lud/i0;)V
