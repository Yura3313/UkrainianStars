...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ly1/c;->c:Ljava/lang/Object;
...
.method public static h(Landroid/content/Context;ILc2/o;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    .line 7
    :cond_2
    invoke-static {p0, p1}, Lc2/p;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 15
    :cond_7
    invoke-static {p0, p1}, Lc2/p;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static i(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    .line 4
    invoke-static {p1, p3}, Ly1/h;->d1(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Ly1/h;

    move-result-object p1

    .line 5
    invoke-virtual {p1, p0, p2}, Ly1/h;->e1(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)V
    ...
    .line 7
    invoke-static {p1, p3}, Ly1/b;->a(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Ly1/b;

    move-result-object p1

    .line 8
    invoke-virtual {p1, p0, p2}, Ly1/b;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    .line 1
    invoke-super {p0, p1, p2, p3}, Ly1/d;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public c(Landroid/content/Context;)I
    ...
    invoke-virtual {p0, p1, v0}, Ly1/c;->d(Landroid/content/Context;I)I
...
.method public d(Landroid/content/Context;I)I
    ...
    .line 1
    invoke-super {p0, p1, p2}, Ly1/d;->d(Landroid/content/Context;I)I
...
.method public e(Landroid/app/Activity;II)Landroid/app/Dialog;
    .locals 2
    ...
    .line 1
    invoke-super {p0, p1, p2, v0}, Ly1/d;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v1, v0, p1, p3}, Lc2/q;-><init>(Landroid/content/Intent;Landroid/app/Activity;I)V

    const/4 p3, 0x0

    .line 3
    invoke-static {p1, p2, v1, p3}, Ly1/c;->h(Landroid/content/Context;ILc2/o;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public g(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    .line 3
    invoke-static {p1, p2, v1, p4}, Ly1/c;->h(Landroid/content/Context;ILc2/o;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 4
    invoke-static {p1, p2, p3, p4}, Ly1/c;->i(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final j(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    .line 3
    new-instance p2, Ly1/c$a;

    invoke-direct {p2, p0, p1}, Ly1/c$a;-><init>(Ly1/c;Landroid/content/Context;)V
    ...
    .line 5
    invoke-static {p1, v2}, Lc2/p;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 6
    :cond_2
    invoke-static {p1, p2}, Lc2/p;->a(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 9
    :cond_4
    invoke-static {p1, p2}, Lc2/p;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_5
    :goto_1
    invoke-static {p1}, Lc2/p;->d(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 11
    invoke-static {p1, v6, v0}, Lc2/p;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7}, Lc2/h;->h(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Lc2/h;->j(Z)V

    .line 40
    sget-object p3, Ly1/c;->c:Ljava/lang/Object;
    ...
    .line 53
    sget-object p3, Ly1/f;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final k(Landroid/app/Activity;La2/i;ILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 1
    .param p1    # Landroid/app/Activity;
        .annotation build Landroidx/annotation/RecentlyNonNull;
        .end annotation
    ...
    .line 1
    invoke-super {p0, p1, p3, v0}, Ly1/d;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    .line 2
    invoke-static {p2, v0}, Lc2/o;->a(La2/i;Landroid/content/Intent;)Lc2/o;

    move-result-object p2

    .line 3
    invoke-static {p1, p3, p2, p4}, Ly1/c;->h(Landroid/content/Context;ILc2/o;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
