...
.method public constructor <init>(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    .line 2
    iput-boolean v0, p0, Ly5/w;->c:Z

    .line 3
    iput-object p1, p0, Ly5/w;->a:Landroid/content/Intent;

    .line 4
    iput-object p2, p0, Ly5/w;->b:Landroid/content/BroadcastReceiver$PendingResult;

    .line 5
    new-instance p2, Lz3/t0;

    invoke-direct {p2, p0, p1}, Lz3/t0;-><init>(Ly5/w;Landroid/content/Intent;)V
    ...
    iput-object p1, p0, Ly5/w;->d:Ljava/util/concurrent/ScheduledFuture;
...
.method public final declared-synchronized a()V
    ...
    .line 1
    :try_start_0
    iget-boolean v0, p0, Ly5/w;->c:Z

    if-nez v0, :cond_0

    .line 2
    iget-object v0, p0, Ly5/w;->b:Landroid/content/BroadcastReceiver$PendingResult;

    invoke-virtual {v0}, Landroid/content/BroadcastReceiver$PendingResult;->finish()V

    .line 3
    iget-object v0, p0, Ly5/w;->d:Ljava/util/concurrent/ScheduledFuture;
