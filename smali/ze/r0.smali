...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lze/r0;->j:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lze/r0;->k:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0}, Lze/s0;-><init>()V

    const/4 v0, 0x0

    .line 2
    iput-object v0, p0, Lze/r0;->_queue:Ljava/lang/Object;

    .line 3
    iput-object v0, p0, Lze/r0;->_delayed:Ljava/lang/Object;
...
.method public final A()Z
    ...
    .line 1
    iget-object v0, p0, Lze/q0;->i:Laf/a;
    ...
    .line 3
    :cond_2
    iget-object v0, p0, Lze/r0;->_delayed:Ljava/lang/Object;

    check-cast v0, Lze/r0$d;
    ...
    .line 5
    :cond_3
    iget-object v0, p0, Lze/r0;->_queue:Ljava/lang/Object;
...
.method public final B()J
    ...
    .line 1
    invoke-virtual/range {p0 .. p0}, Lze/q0;->v()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual/range {p0 .. p0}, Lze/r0;->z()J
    ...
    .line 2
    :cond_0
    iget-object v0, v1, Lze/r0;->_delayed:Ljava/lang/Object;

    move-object v2, v0

    check-cast v2, Lze/r0$d;
    ...
    .line 7
    check-cast v9, Lze/r0$c;

    .line 8
    iget-wide v10, v9, Lze/r0$c;->i:J
    ...
    .line 9
    invoke-virtual {v1, v9}, Lze/r0;->y(Ljava/lang/Runnable;)Z
    ...
    :cond_5
    :goto_5
    iget-object v2, v1, Lze/r0;->_queue:Ljava/lang/Object;
    ...
    .line 32
    :cond_f
    sget-object v3, Lze/r0;->j:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public final D(JLze/r0$c;)V
    .locals 12

    .line 1
    iget-boolean v0, p0, Lze/r0;->isCompleted:Z
    ...
    .line 3
    :cond_1
    sget-object v0, Lze/r0;->k:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;

    new-instance v5, Lze/r0$d;

    invoke-direct {v5, p1, p2}, Lze/r0$d;-><init>(J)V
    ...
    .line 6
    :try_start_0
    iget-object v5, p3, Lze/r0$c;->g:Ljava/lang/Object;

    .line 7
    sget-object v6, Lze/t0;->a:Laf/w;
    :try_end_0
    ...
    check-cast v5, Lze/r0$c;

    .line 11
    iget-boolean v6, p0, Lze/r0;->isCompleted:Z
    :try_end_2
    ...
    .line 13
    :try_start_4
    iput-wide p1, v0, Lze/r0$d;->b:J

    goto :goto_3

    .line 14
    :cond_6
    iget-wide v8, v5, Lze/r0$c;->i:J
    ...
    iput-wide v8, v0, Lze/r0$d;->b:J

    .line 16
    :cond_8
    :goto_3
    iget-wide v8, p3, Lze/r0$c;->i:J
    ...
    invoke-virtual {v0, p1, p2, p3}, Lze/r0;->D(JLze/r0$c;)V

    goto :goto_6

    .line 23
    :cond_c
    iget-object p1, p0, Lze/r0;->_delayed:Ljava/lang/Object;

    check-cast p1, Lze/r0$d;
    ...
    .line 28
    invoke-virtual {p0}, Lze/s0;->w()Ljava/lang/Thread;
...
.method public final dispatch(Lke/f;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p2}, Lze/r0;->x(Ljava/lang/Runnable;)V
...
.method public final scheduleResumeAfterDelay(JLze/f;)V
    ...
    .line 1
    invoke-static {p1, p2}, Lze/t0;->a(J)J
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lze/r0$a;-><init>(Lze/r0;JLze/f;)V

    .line 4
    new-instance p1, Lze/n0;

    invoke-direct {p1, v2}, Lze/n0;-><init>(Lze/m0;)V
    ...
    .line 5
    invoke-virtual {p0, v0, v1, v2}, Lze/r0;->D(JLze/r0$c;)V
...
.method public final shutdown()V
    ...
    .line 2
    sget-object v0, Lze/r1;->a:Ljava/lang/ThreadLocal;
    ...
    .line 3
    iput-boolean v0, p0, Lze/r0;->isCompleted:Z
    ...
    .line 5
    :cond_0
    iget-object v2, p0, Lze/r0;->_queue:Ljava/lang/Object;
    ...
    .line 6
    sget-object v4, Lze/r0;->j:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;

    .line 7
    sget-object v5, Lze/t0;->b:Laf/w;
    ...
    .line 14
    sget-object v5, Lze/r0;->j:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    .line 17
    :goto_3
    iget-object v2, p0, Lze/r0;->_delayed:Ljava/lang/Object;
    ...
    check-cast v2, Lze/r0$c;

    if-eqz v2, :cond_9

    .line 18
    sget-boolean v3, Lze/c0;->a:Z

    .line 19
    sget-object v3, Lze/d0;->m:Lze/d0;

    invoke-virtual {v3, v0, v1, v2}, Lze/r0;->D(JLze/r0$c;)V
...
.method public final x(Ljava/lang/Runnable;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Lze/r0;->y(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {v0, p1}, Lze/r0;->x(Ljava/lang/Runnable;)V
...
.method public final y(Ljava/lang/Runnable;)Z
    ...
    .line 2
    iget-boolean v1, p0, Lze/r0;->isCompleted:Z
    ...
    .line 6
    :cond_6
    sget-object v2, Lze/r0;->j:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
