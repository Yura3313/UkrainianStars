...
.field public static final g:Lze/m;
...
.method public final dispatch(Lke/f;Ljava/lang/Runnable;)V
    ...
    .line 1
    :try_start_0
    sget-object p1, Lze/m;->pool:Ljava/util/concurrent/Executor;
    ...
    :cond_1
    invoke-virtual {p0}, Lze/m;->r()Ljava/util/concurrent/ExecutorService;

    move-result-object p1

    sput-object p1, Lze/m;->pool:Ljava/util/concurrent/Executor;
    :try_end_1
    ...
    .line 6
    :catch_0
    sget-object p1, Lze/c0;->l:Lze/c0;

    invoke-virtual {p1, p2}, Lze/q0;->x(Ljava/lang/Runnable;)V
...
.method public final n()Ljava/util/concurrent/ExecutorService;
    ...
    .line 2
    invoke-virtual {p0}, Lze/m;->s()I

    move-result v1

    new-instance v2, Lze/m$a;

    invoke-direct {v2, v0}, Lze/m$a;-><init>(Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public final r()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual {p0}, Lze/m;->n()Ljava/util/concurrent/ExecutorService;
    ...
    sget-object v3, Lze/m;->g:Lze/m;

    invoke-virtual {v3}, Lze/m;->s()I
