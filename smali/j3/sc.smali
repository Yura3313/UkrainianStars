...
.method public static a(Landroid/view/MotionEvent;Landroid/view/View;)Landroid/graphics/Point;
    ...
    .line 1
    invoke-static {p1}, Lj3/sc;->m(Landroid/view/View;)[I
...
.method public static b(Landroid/content/Context;Landroid/graphics/Point;Landroid/graphics/Point;)Lorg/json/JSONObject;
    ...
    invoke-static {p0, v2}, Lj3/sc;->h(Landroid/content/Context;I)I
    ...
    invoke-static {p0, p2}, Lj3/sc;->h(Landroid/content/Context;I)I
    ...
    invoke-static {p0, v1}, Lj3/sc;->h(Landroid/content/Context;I)I
    ...
    invoke-static {p0, p1}, Lj3/sc;->h(Landroid/content/Context;I)I
...
.method public static d(Landroid/content/Context;Landroid/view/View;)Lorg/json/JSONObject;
    ...
    .line 2
    :try_start_0
    invoke-static/range {p1 .. p1}, Lj3/sc;->m(Landroid/view/View;)[I
    ...
    .line 12
    invoke-static {v0, v14}, Lj3/sc;->h(Landroid/content/Context;I)I
    ...
    invoke-static {v0, v15}, Lj3/sc;->h(Landroid/content/Context;I)I
    ...
    invoke-static {v0, v13}, Lj3/sc;->h(Landroid/content/Context;I)I
    ...
    .line 23
    invoke-static {v0, v9}, Lj3/sc;->c(Landroid/content/Context;Landroid/graphics/Rect;)Lorg/json/JSONObject;
    ...
    invoke-static {v0, v6}, Lj3/sc;->h(Landroid/content/Context;I)I
    ...
    invoke-static {v0, v5}, Lj3/sc;->h(Landroid/content/Context;I)I
...
.method public static e(Landroid/content/Context;Ljava/util/Map;Ljava/util/Map;Landroid/view/View;)Lorg/json/JSONObject;
    ...
    .line 2
    :cond_0
    invoke-static/range {p3 .. p3}, Lj3/sc;->m(Landroid/view/View;)[I
    ...
    .line 5
    invoke-static {v12}, Lj3/sc;->m(Landroid/view/View;)[I
    ...
    .line 9
    invoke-static {v0, v10}, Lj3/sc;->h(Landroid/content/Context;I)I
    ...
    .line 18
    invoke-static {v0, v10}, Lj3/sc;->c(Landroid/content/Context;Landroid/graphics/Rect;)Lorg/json/JSONObject;
...
.method public static f(Ljava/lang/String;Landroid/content/Context;Landroid/graphics/Point;Landroid/graphics/Point;)Lorg/json/JSONObject;
    ...
    .line 2
    invoke-static {p1, p2, p3}, Lj3/sc;->b(Landroid/content/Context;Landroid/graphics/Point;Landroid/graphics/Point;)Lorg/json/JSONObject;
...
.method public static g(Lj3/lg0;)Z
    .locals 2
    ...
    iget-boolean p0, p0, Lj3/lg0;->H:Z
...
.method public static h(Landroid/content/Context;I)I
    ...
    .line 2
    invoke-virtual {v0, p0, p1}, Lj3/bd;->d(Landroid/content/Context;I)I
...
.method public static j(Landroid/content/Context;)Lorg/json/JSONObject;
    ...
    .line 4
    invoke-static {v1}, Lj3/bb;->b(Landroid/view/WindowManager;)Landroid/util/DisplayMetrics;
    ...
    invoke-static {p0, v3}, Lj3/sc;->h(Landroid/content/Context;I)I
