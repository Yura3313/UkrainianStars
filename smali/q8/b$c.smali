...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lq8/b;->H(Ljava/lang/Long;Ljava/lang/String;ILjava/lang/String;Z)V
.end annotation
...
# direct methods
.method public constructor <init>(Lq8/b;Ljava/lang/Long;Ljava/lang/String;ILjava/lang/String;Z)V
    .locals 0

    iput-object p1, p0, Lq8/b$c;->f:Lq8/b;

    iput-object p2, p0, Lq8/b$c;->b:Ljava/lang/Long;

    iput-object p3, p0, Lq8/b$c;->c:Ljava/lang/String;

    iput p4, p0, Lq8/b$c;->d:I

    iput-object p5, p0, Lq8/b$c;->e:Ljava/lang/String;
...
.method public final g()V
    ...
    .line 1
    iget-object v0, p0, Lq8/b$c;->f:Lq8/b;

    iget-object v0, v0, Lq8/b;->b:Lb8/s;

    iget-object v1, p0, Lq8/b$c;->b:Ljava/lang/Long;

    iget-object v2, p0, Lq8/b$c;->c:Ljava/lang/String;

    iget v3, p0, Lq8/b$c;->d:I

    iget-object v4, p0, Lq8/b$c;->e:Ljava/lang/String;

    check-cast v0, Lb8/l;

    .line 2
    iget-object v5, v0, Lb8/l;->s:Landroid/content/Context;
    ...
    .line 3
    :cond_0
    iget-object v5, v0, Lb8/l;->a:Landroid/content/Context;
    ...
    .line 4
    invoke-static {v6, v2, v7, v4, v8}, Lcom/android/billingclient/api/f;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    .line 6
    invoke-static {v8, v6, v7, v7}, Lcom/android/billingclient/api/w;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Lz9/a;)V
    ...
    .line 9
    iget-object v6, v6, Lx7/g;->j:Lr9/h;

    .line 10
    iget-object v8, v6, Lr9/h;->b:Lr9/b;

    if-eqz v8, :cond_1

    .line 11
    iget-object v8, v6, Lr9/h;->a:Lx7/g;

    new-instance v9, Lr9/k;

    invoke-direct {v9, v6, v3}, Lr9/k;-><init>(Lr9/h;I)V

    invoke-virtual {v8, v9}, Lx7/g;->g(Ll7/a;)V
    ...
    .line 17
    :cond_2
    sget-object v8, Lcom/helpshift/util/t;->c:La7/g;

    .line 18
    iget-object v8, v8, La7/g;->a:Lg8/b;

    const-string v10, "notificationIconId"

    .line 19
    invoke-virtual {v8, v10}, Lg8/b;->g(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    .line 35
    invoke-direct {v10, v5, v7}, Lu/h;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 36
    iget-object v11, v10, Lu/h;->q:Landroid/app/Notification;

    iput v6, v11, Landroid/app/Notification;->icon:I

    .line 37
    invoke-virtual {v10, v4}, Lu/h;->e(Ljava/lang/CharSequence;)Lu/h;

    .line 38
    invoke-virtual {v10, v3}, Lu/h;->d(Ljava/lang/CharSequence;)Lu/h;

    .line 39
    iput-object v1, v10, Lu/h;->f:Landroid/app/PendingIntent;
    ...
    .line 41
    invoke-virtual {v10, v8}, Lu/h;->g(Landroid/graphics/Bitmap;)Lu/h;
    ...
    .line 45
    invoke-virtual {v3, v4}, Lg8/b;->g(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    .line 47
    invoke-static {v5, v3}, Lk/c;->f(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 48
    invoke-virtual {v10, v1}, Lu/h;->f(I)Lu/h;
    ...
    .line 50
    :cond_8
    invoke-virtual {v10, v1}, Lu/h;->h(Landroid/net/Uri;)Lu/h;
    ...
    iget-object v4, v0, Lb8/l;->a:Landroid/content/Context;
    ...
    .line 59
    invoke-static {v4, v3, v7, v7}, Lcom/android/billingclient/api/w;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Lz9/a;)V
