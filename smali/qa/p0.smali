...
.method public final a(Landroidx/recyclerview/widget/RecyclerView$z;Ll8/y;)V
    ...
    .line 1
    check-cast p1, Lqa/p0$a;

    check-cast p2, Ll8/v0;

    .line 2
    iget v0, p2, Ll8/r0;->z:I

    .line 3
    iget-object v1, p2, Ll8/v0;->A:Ljava/util/List;
    ...
    .line 4
    iget-object v1, p1, Lqa/p0$a;->y:Landroid/widget/TextView;

    iget-object v5, p2, Ll8/v0;->A:Ljava/util/List;
    ...
    .line 5
    iget-object v1, p1, Lqa/p0$a;->z:Landroid/widget/TextView;
    ...
    invoke-static {v5, v6}, Lcom/helpshift/util/b0;->b(Landroid/content/Context;I)I
    ...
    invoke-static {v2, v5}, Lcom/helpshift/util/b0;->b(Landroid/content/Context;I)I
    ...
    invoke-static {v2, v3}, Lcom/helpshift/util/b0;->b(Landroid/content/Context;I)I
    ...
    .line 19
    :goto_2
    iget-object v2, p1, Lqa/p0$a;->D:Landroid/view/View;

    invoke-virtual {v2, v6}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    .line 20
    iget-object v2, p1, Lqa/p0$a;->A:Landroid/widget/TextView;

    invoke-virtual {v2, v5}, Landroid/widget/TextView;->setTextColor(I)V

    .line 21
    iget-object v2, p1, Lqa/p0$a;->C:Landroid/widget/FrameLayout;
    ...
    .line 24
    iget-object v1, p1, Lqa/p0$a;->B:Landroid/widget/ImageView;
    ...
    .line 26
    iget-object v1, p1, Lqa/p0$a;->C:Landroid/widget/FrameLayout;

    invoke-virtual {p0, v1, p2}, Lqa/u;->j(Landroid/view/View;Ll8/l0;)V

    .line 27
    iget-object v1, p1, Lqa/p0$a;->A:Landroid/widget/TextView;

    invoke-virtual {p0, v1, p2, v0}, Lqa/u;->l(Landroid/widget/TextView;Ll8/l0;Ljava/lang/String;)V

    if-eqz v4, :cond_5

    .line 28
    iget-object p2, p1, Lqa/p0$a;->B:Landroid/widget/ImageView;
    ...
    .line 29
    :cond_5
    iget-object p1, p1, Lqa/p0$a;->B:Landroid/widget/ImageView;
...
.method public final b(Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    .line 2
    new-instance v0, Lqa/p0$a;

    invoke-direct {v0, p0, p1}, Lqa/p0$a;-><init>(Lqa/p0;Landroid/view/View;)V

    .line 3
    iget-object p1, v0, Lqa/p0$a;->C:Landroid/widget/FrameLayout;
    ...
    .line 4
    iget-object p1, v0, Lqa/p0$a;->D:Landroid/view/View;
