...
.method public final a(Landroidx/recyclerview/widget/RecyclerView$z;Ll8/y;)V
    ...
    .line 2
    iget-object v0, p2, Ll8/y;->j:Ljava/lang/String;
    ...
    .line 3
    iget-object v0, p1, Lqa/p$a;->B:Landroid/view/View;
    ...
    .line 5
    iget-object v0, p1, Lqa/p$a;->z:Landroid/widget/TextView;
    ...
    .line 9
    :goto_0
    iget-object v1, p1, Lqa/p$a;->B:Landroid/view/View;

    sget v2, Lcom/helpshift/R$attr;->hs__chatBubbleAdminBackgroundColor:I

    invoke-virtual {p0, v1, v0, v2}, Lqa/u;->i(Landroid/view/View;II)V
    ...
    invoke-direct {v1, p0, p2}, Lqa/o;-><init>(Lqa/p;Ll8/y;)V

    invoke-virtual {p0, v0, v1}, Lqa/u;->e(Landroid/widget/TextView;Lcom/helpshift/util/o$b;)V

    .line 12
    iget-object v0, p1, Lqa/p$a;->D:Lcom/helpshift/views/CircleImageView;

    invoke-virtual {p0, p2, v0}, Lqa/u;->h(Ll8/y;Lcom/helpshift/views/CircleImageView;)V

    .line 13
    :goto_1
    iget-object v0, p1, Lqa/p$a;->y:Landroid/widget/TableLayout;
    ...
    check-cast v2, Ll8/t$a;

    .line 15
    iget-object v3, p0, Lqa/u;->a:Landroid/content/Context;
    ...
    .line 18
    iget-object v5, v2, Ll8/t$a;->f:Ljava/lang/String;
    ...
    invoke-static {v5, v4, v6}, Lcom/helpshift/util/b0;->e(Landroid/content/Context;Landroid/graphics/drawable/Drawable;I)V
    ...
    .line 26
    invoke-static {v7, v8}, Lcom/helpshift/util/b0;->b(Landroid/content/Context;I)I
    ...
    .line 29
    iget-object v5, p1, Lqa/p$a;->y:Landroid/widget/TableLayout;

    invoke-virtual {v5, v4}, Landroid/widget/TableLayout;->addView(Landroid/view/View;)V

    .line 30
    iget-object v4, p1, Lqa/p$a;->y:Landroid/widget/TableLayout;
    ...
    invoke-direct {v4, p0, p2, v2}, Lqa/n;-><init>(Lqa/p;Ll8/t;Ll8/t$a;)V
    ...
    .line 34
    iget-object v1, p1, Lqa/p$a;->A:Landroid/widget/TextView;

    .line 35
    iget-boolean v2, v0, Ll8/l0;->f:Z

    .line 36
    invoke-virtual {p0, v1, v2}, Lqa/u;->m(Landroid/view/View;Z)V
    ...
    .line 38
    iget-object v0, p1, Lqa/p$a;->A:Landroid/widget/TextView;
    ...
    .line 39
    :cond_3
    iget-object p1, p1, Lqa/p$a;->C:Landroid/view/View;
...
.method public final b(Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    invoke-direct {v0, p1}, Lqa/p$a;-><init>(Landroid/view/View;)V
