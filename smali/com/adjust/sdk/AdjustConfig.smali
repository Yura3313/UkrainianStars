...
.field public onObservationJsonStringListener:Lcom/adjust/sdk/OnObservationJsonStringListener;

.field public onObservationPackageListener:Lcom/adjust/sdk/OnObservationPackageListener;
...
.field public unbotifyLabel:Ljava/lang/Integer;

.field public unbotifyPath:Ljava/lang/String;

.field public unbotifyProfile:Ljava/lang/Integer;
...
.method private init(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-static {v1}, Lcom/adjust/sdk/AdjustLifecycleCallbacks;->injectWindowCallback(Landroid/app/Activity;)V
    ...
    :goto_2
    iput-object p4, p0, Lcom/adjust/sdk/AdjustConfig;->application:Landroid/app/Application;
    ...
    invoke-static {p4}, Lcom/adjust/sdk/AdjustLifecycleCallbacks;->injectWindowCallback(Landroid/app/Activity;)V

    :cond_5
    iget-object p4, p0, Lcom/adjust/sdk/AdjustConfig;->application:Landroid/app/Application;
    ...
    invoke-static {p4, v1, v2, v3}, Lcom/adjust/sdk/Reflection;->invokeStaticMethod(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p4

    instance-of v1, p4, Landroid/app/Application;
    ...
    new-instance v1, Lcom/adjust/sdk/AdjustLifecycleCallbacks;

    invoke-direct {v1}, Lcom/adjust/sdk/AdjustLifecycleCallbacks;-><init>()V

    invoke-virtual {p4, v1}, Landroid/app/Application;->registerActivityLifecycleCallbacks(Landroid/app/Application$ActivityLifecycleCallbacks;)V

    goto :goto_7

    :cond_9
    iget-object p4, p0, Lcom/adjust/sdk/AdjustConfig;->logger:Lcom/adjust/sdk/ILogger;

    new-array v1, v0, [Ljava/lang/Object;

    const-string v2, "Could not obtain Application instance"

    invoke-interface {p4, v2, v1}, Lcom/adjust/sdk/ILogger;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iput-boolean v0, p0, Lcom/adjust/sdk/AdjustConfig;->sendInBackground:Z

    iput-boolean v0, p0, Lcom/adjust/sdk/AdjustConfig;->preinstallTrackingEnabled:Z
...
.method public setOnObservationJsonStringListener(Lcom/adjust/sdk/OnObservationJsonStringListener;)V
    .locals 0

    iput-object p1, p0, Lcom/adjust/sdk/AdjustConfig;->onObservationJsonStringListener:Lcom/adjust/sdk/OnObservationJsonStringListener;

    return-void
.end method

.method public setOnObservationPackageListener(Lcom/adjust/sdk/OnObservationPackageListener;)V
    .locals 0

    iput-object p1, p0, Lcom/adjust/sdk/AdjustConfig;->onObservationPackageListener:Lcom/adjust/sdk/OnObservationPackageListener;

    return-void
.end method

.method public setOnObservationReportListener(Lcom/adjust/sdk/OnObservationReportListener;)V
    .locals 2
    ...
    const-string v1, "setOnObservationReportListener has been deprecated and shouldn\'t be used anymore"
...
.method public setSessionId(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/adjust/sdk/AdjustConfig;->sessionId:Ljava/lang/String;

    return-void
.end method

.method public setUnbotifyLabel(Ljava/lang/Integer;)V
    .locals 0

    iput-object p1, p0, Lcom/adjust/sdk/AdjustConfig;->unbotifyLabel:Ljava/lang/Integer;

    return-void
.end method

.method public setUnbotifyProfile(Ljava/lang/Integer;)V
    .locals 0

    iput-object p1, p0, Lcom/adjust/sdk/AdjustConfig;->unbotifyProfile:Ljava/lang/Integer;
