...
.field private disableThirdPartySharingPath:Ljava/lang/String;
...
.field private unbotifyHandler:Lcom/adjust/sdk/IUnbotifyHandler;
...
.method private constructor <init>(Lcom/adjust/sdk/AdjustConfig;)V
    ...
    invoke-direct {p0}, Lcom/adjust/sdk/ActivityHandler;->initUnbotify()V
...
.method public static synthetic access$1600(Lcom/adjust/sdk/ActivityHandler;Lcom/adjust/sdk/ReferrerDetails;Ljava/lang/String;)V
    .locals 0
...
.method private canProcessEvent()Z
    .locals 2
...
.method private initI()V
    ...
    iget-object v3, v0, Lcom/adjust/sdk/AdjustConfig;->unbotifyPath:Ljava/lang/String;

    iput-object v3, p0, Lcom/adjust/sdk/ActivityHandler;->unbotifyPath:Ljava/lang/String;
...
.method private initUnbotify()V
    .locals 5

    invoke-static {p0}, Lcom/adjust/sdk/AdjustFactory;->getUnbotifyHandler(Lcom/adjust/sdk/IActivityHandler;)Lcom/adjust/sdk/IUnbotifyHandler;

    move-result-object v0

    iput-object v0, p0, Lcom/adjust/sdk/ActivityHandler;->unbotifyHandler:Lcom/adjust/sdk/IUnbotifyHandler;

    iget-object v1, p0, Lcom/adjust/sdk/ActivityHandler;->adjustConfig:Lcom/adjust/sdk/AdjustConfig;

    iget-object v2, v1, Lcom/adjust/sdk/AdjustConfig;->context:Landroid/content/Context;

    iget-object v3, v1, Lcom/adjust/sdk/AdjustConfig;->appToken:Ljava/lang/String;

    invoke-direct {p0, v2}, Lcom/adjust/sdk/ActivityHandler;->getAppVersion(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v4

    invoke-static {v1, v4}, Lcom/adjust/sdk/UnbotifyUtil;->buildConfig(Lcom/adjust/sdk/AdjustConfig;Ljava/lang/String;)Lcom/unbotify/mobile/sdk/storage/UnbotifyConfig;

    move-result-object v1

    invoke-static {v2, v0, v3, v1}, Lcom/unbotify/mobile/sdk/Unbotify;->init(Landroid/content/Context;Lcom/unbotify/mobile/sdk/managers/OnNetworkReportListener;Ljava/lang/String;Lcom/unbotify/mobile/sdk/storage/UnbotifyConfig;)V

    iget-object v0, p0, Lcom/adjust/sdk/ActivityHandler;->adjustConfig:Lcom/adjust/sdk/AdjustConfig;

    invoke-static {}, Lcom/unbotify/mobile/sdk/Unbotify;->getSessionId()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/adjust/sdk/AdjustConfig;->setSessionId(Ljava/lang/String;)V
...
.method private pauseSendingI()V
    ...
    iget-object v0, p0, Lcom/adjust/sdk/ActivityHandler;->unbotifyHandler:Lcom/adjust/sdk/IUnbotifyHandler;

    invoke-interface {v0}, Lcom/adjust/sdk/IUnbotifyHandler;->pauseSending()V
    ...
    invoke-interface {v0}, Lcom/adjust/sdk/IUnbotifyHandler;->resumeSending()V
...
.method private readActivityStateI(Landroid/content/Context;)V
    ...
    invoke-static {p1, v1, v0, v3}, Lcom/adjust/sdk/Util;->readObject(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v1, p1, v3}, Lcom/adjust/sdk/ILogger;->error(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public getUnbotifyPath()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/adjust/sdk/ActivityHandler;->unbotifyPath:Ljava/lang/String;
