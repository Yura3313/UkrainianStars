...
.method public static showPunishment(Landroid/app/Activity;Lcom/kakaogame/auth/LoginData;)Lcom/kakaogame/KGResult;
    ...
    .line 17
    sget v4, Lcom/kakaogame/R$string;->zinny_sdk_email_inquire_button:I
    ...
    invoke-virtual {v4, v9}, Lcom/kakaogame/core/CoreManager;->hasCustomAlertHandler(Lcom/kakaogame/KGCustomUI$KGCustomAlertType;)Z
    ...
    .line 19
    :try_start_1
    new-instance v4, Lcom/kakaogame/auth/view/LoginUIManager$15;

    invoke-direct {v4}, Lcom/kakaogame/auth/view/LoginUIManager$15;-><init>()V
    ...
    const-string v17, "customUI_close"
    :try_end_1
    ...
    .line 22
    invoke-virtual {v4, v0, v9}, Lcom/kakaogame/core/CoreManager;->showCustomUI(Landroid/app/Activity;Lcom/kakaogame/KGCustomUI$KGCustomAlert;)Ljava/lang/String;
    ...
    .line 24
    sget v3, Lcom/kakaogame/R$string;->zinny_sdk_email_title:I
    ...
    invoke-static {v0, v9, v1}, Lcom/kakaogame/util/ResourceUtil;->getString(Landroid/content/Context;I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 36
    invoke-virtual {v14, v11}, Landroid/app/AlertDialog$Builder;->setMessage(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;

    .line 37
    new-instance v10, Lcom/kakaogame/auth/view/LoginUIManager$16;

    invoke-direct {v10, v13}, Lcom/kakaogame/auth/view/LoginUIManager$16;-><init>(Lcom/kakaogame/util/MutexLock;)V

    invoke-virtual {v14, v1, v10}, Landroid/app/AlertDialog$Builder;->setNegativeButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    .line 38
    new-instance v1, Lcom/kakaogame/auth/view/LoginUIManager$17;

    invoke-direct {v1, v5, v13}, Lcom/kakaogame/auth/view/LoginUIManager$17;-><init>(Ljava/lang/String;Lcom/kakaogame/util/MutexLock;)V

    invoke-virtual {v14, v12, v1}, Landroid/app/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    .line 39
    invoke-virtual {v14, v6}, Landroid/app/AlertDialog$Builder;->setCancelable(Z)Landroid/app/AlertDialog$Builder;

    .line 40
    invoke-static {v0, v14}, Lcom/kakaogame/ui/DialogManager;->showAlertDialogBuilder(Landroid/app/Activity;Landroid/app/AlertDialog$Builder;)V

    .line 41
    new-instance v1, Lcom/kakaogame/auth/view/LoginUIManager$18;

    invoke-direct {v1, v13}, Lcom/kakaogame/auth/view/LoginUIManager$18;-><init>(Lcom/kakaogame/util/MutexLock;)V

    invoke-virtual {v0, v1}, Landroid/app/Activity;->runOnUiThread(Ljava/lang/Runnable;)V

    .line 42
    invoke-virtual {v13}, Lcom/kakaogame/util/MutexLock;->lock()V
    ...
    invoke-static {v0, v10, v4}, Lcom/kakaogame/util/ResourceUtil;->getString(Landroid/content/Context;I[Ljava/lang/Object;)Ljava/lang/String;
