...
.method public static enable(ZIZ)V
    ...
    .line 3
    sget-object p0, Lcom/supercell/titan/UnbotifyManager;->c:Lcom/supercell/titan/GameApp;

    const-string v0, "ADJUST_APP_TOKEN"

    invoke-virtual {p0, v0}, Lcom/supercell/titan/GameApp;->getBuildConfigFromGame(Ljava/lang/String;)Ljava/lang/Object;
    ...
    const-string v1, "UNBOTIFY_LABEL"
    ...
    sget-object v2, Lcom/supercell/titan/UnbotifyManager;->c:Lcom/supercell/titan/GameApp;
    ...
    :goto_0
    invoke-direct {v1, v2, p0, v3}, Lcom/adjust/sdk/AdjustConfig;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    if-eqz p2, :cond_2

    .line 6
    sget-object p0, Lcom/adjust/sdk/LogLevel;->SUPRESS:Lcom/adjust/sdk/LogLevel;

    goto :goto_1

    :cond_2
    sget-object p0, Lcom/adjust/sdk/LogLevel;->INFO:Lcom/adjust/sdk/LogLevel;

    :goto_1
    invoke-virtual {v1, p0}, Lcom/adjust/sdk/AdjustConfig;->setLogLevel(Lcom/adjust/sdk/LogLevel;)V

    .line 7
    invoke-virtual {v1, v0}, Lcom/adjust/sdk/AdjustConfig;->setUnbotifyLabel(Ljava/lang/Integer;)V

    .line 8
    new-instance p0, Lcom/supercell/titan/l0;

    invoke-direct {p0}, Lcom/supercell/titan/l0;-><init>()V

    invoke-virtual {v1, p0}, Lcom/adjust/sdk/AdjustConfig;->setOnObservationPackageListener(Lcom/adjust/sdk/OnObservationPackageListener;)V
