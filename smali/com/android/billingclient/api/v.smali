...
.method public static final a(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lxe/h;->c(Ljava/util/Iterator;)Lxe/d;
...
.method public static final b(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)Landroid/graphics/drawable/NinePatchDrawable;
    .locals 16
    ...
    invoke-direct {v4, v3, v6, v5}, Luc/m;-><init>(Ljava/util/List;Ljava/util/List;Landroid/graphics/Rect;)V
    ...
    .line 24
    invoke-static {v1, v0, v4}, Lcom/android/billingclient/api/v;->d(Landroid/content/res/Resources;Landroid/graphics/Bitmap;Luc/m;)Landroid/graphics/drawable/NinePatchDrawable;
...
.method public static final c(Landroid/content/res/Resources;Landroid/graphics/Bitmap;IIII)Landroid/graphics/drawable/NinePatchDrawable;
    .locals 2
    ...
    invoke-static {p4}, Lcom/android/billingclient/api/y;->c(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-direct {v0, p2, p3, p4}, Luc/m;-><init>(Ljava/util/List;Ljava/util/List;Landroid/graphics/Rect;)V

    invoke-static {p0, p1, v0}, Lcom/android/billingclient/api/v;->d(Landroid/content/res/Resources;Landroid/graphics/Bitmap;Luc/m;)Landroid/graphics/drawable/NinePatchDrawable;
...
.method public static final d(Landroid/content/res/Resources;Landroid/graphics/Bitmap;Luc/m;)Landroid/graphics/drawable/NinePatchDrawable;
    .locals 10

    .line 1
    iget-object v0, p2, Luc/m;->a:Ljava/util/List;
    ...
    .line 3
    iget-object v1, p2, Luc/m;->b:Ljava/util/List;
    ...
    .line 6
    iget-object v2, p2, Luc/m;->a:Ljava/util/List;
    ...
    .line 8
    iget-object v2, p2, Luc/m;->b:Ljava/util/List;
    ...
    .line 13
    iget-object v3, p2, Luc/m;->c:Landroid/graphics/Rect;
    ...
    .line 44
    iget-object v8, p2, Luc/m;->c:Landroid/graphics/Rect;
