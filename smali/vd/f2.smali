...
.method public a(Lyd/d$a;)Lyd/c;
    ...
    .line 1
    invoke-interface/range {p1 .. p1}, Lyd/d$a;->request()Lyd/b;

    move-result-object v0

    move-object/from16 v1, p1

    invoke-interface {v1, v0}, Lyd/d$a;->a(Lyd/b;)Lyd/c;

    move-result-object v0

    .line 2
    invoke-virtual {v0}, Lyd/c;->d()Landroid/view/View;

    move-result-object v8

    invoke-virtual {v0}, Lyd/c;->b()Landroid/content/Context;

    move-result-object v9

    invoke-virtual {v0}, Lyd/c;->a()Landroid/util/AttributeSet;
    ...
    .line 13
    invoke-static {v13}, Lcom/android/billingclient/api/a0;->b(I)F
    ...
    .line 16
    invoke-static {v14}, Lcom/android/billingclient/api/a0;->b(I)F
    ...
    .line 19
    invoke-static {v8, v1, v2, v3}, Lvd/g2;->q(Landroid/view/View;IZI)V
    ...
    .line 22
    invoke-static {v8, v2, v1}, Lvd/g2;->r(Landroid/view/View;II)V
    ...
    .line 25
    invoke-static/range {v1 .. v6}, Lvd/g2;->s(Landroid/view/View;FFFFF)V
    :try_end_0
    ...
    sget-object v2, Lpc/m;->k:Lpc/m;

    invoke-static {v9}, Lpc/m;->g(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->q(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->s(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->d(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->e(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->f(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->j(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->b(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->l(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->o(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->r(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->a(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->p(Landroid/content/Context;)Lpc/m;
    ...
    invoke-static {v9}, Lpc/m;->c(Landroid/content/Context;)Lpc/m;
    ...
    :cond_9
    :goto_2
    invoke-virtual {v0}, Lyd/c;->c()Lyd/c$a;

    move-result-object v0

    invoke-virtual {v0, v8}, Lyd/c$a;->b(Landroid/view/View;)Lyd/c$a;
