...
.method public static b(Lp5/v$b;)Ljava/security/KeyPair;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/GeneralSecurityException;
    ...
    .line 1
    invoke-static {p0}, Lp5/v;->c(Lp5/v$b;)Ljava/security/spec/ECParameterSpec;

    move-result-object p0

    .line 2
    sget-object v0, Lp5/x;->i:Lp5/x;
...
.method public static c(Lp5/v$b;)Ljava/security/spec/ECParameterSpec;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 2
    invoke-static {p0, v0, v1, v2, v3}, Lp5/v;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
...
.method public static d(Lp5/v$b;[B)Ljava/security/interfaces/ECPrivateKey;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/GeneralSecurityException;
    ...
    .line 4
    sget-object p0, Lp5/x;->j:Lp5/x;

    const-string v0, "EC"

    invoke-virtual {p0, v0}, Lp5/x;->a(Ljava/lang/String;)Ljava/lang/Object;
...
.method public static e(Lp5/v$b;[B[B)Ljava/security/interfaces/ECPublicKey;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/GeneralSecurityException;
    ...
    invoke-static {p2, p1}, Lp5/v;->a(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V
    ...
    invoke-virtual {p0, p2}, Lp5/x;->a(Ljava/lang/String;)Ljava/lang/Object;
