...
.method public constructor <init>(Landroidx/media/MediaBrowserServiceCompat$i;Landroidx/media/MediaBrowserServiceCompat$j;Ljava/lang/String;Landroid/support/v4/os/ResultReceiver;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/media/f;->h:Landroidx/media/MediaBrowserServiceCompat$i;

    iput-object p2, p0, Landroidx/media/f;->a:Landroidx/media/MediaBrowserServiceCompat$j;

    iput-object p4, p0, Landroidx/media/f;->b:Landroid/support/v4/os/ResultReceiver;
...
.method public run()V
    ...
    .line 2
    iget-object v1, p0, Landroidx/media/f;->h:Landroidx/media/MediaBrowserServiceCompat$i;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Landroidx/media/f;->h:Landroidx/media/MediaBrowserServiceCompat$i;

    iget-object v0, v0, Landroidx/media/MediaBrowserServiceCompat$i;->a:Landroidx/media/MediaBrowserServiceCompat;

    iget-object v1, p0, Landroidx/media/f;->b:Landroid/support/v4/os/ResultReceiver;
